...
(function() {
	...
	h.toString = function(d) {
		...
		if (C$1(this)) return "0";
		if (B$1(this)) return "-" + x$1(this).toString(d);
		const a = v$1(Math.pow(d, 6));
		var c = this;
		let f = "";
		for (;;) {
			const e = D$1(c, a).g;
	...
	function D$1(d, a) {
		if (C$1(a)) throw Error("division by zero");
		if (C$1(d)) return new H$1(w, w);
		if (B$1(d)) return a = D$1(x$1(d), a), new H$1(x$1(a.g), x$1(a.h));
		if (B$1(a)) return a = D$1(d, x$1(a)), new H$1(x$1(a.g), a.h);
		if (d.g.length > 30) {
		...
		for (e = w; d.l(a) >= 0;) {
			...
			g = v$1(c);
			for (b = g.j(a); B$1(b) || b.l(d) > 0;) c -= f, g = v$1(c), b = g.j(a);
			C$1(g) && (g = z$1);
			e = e.add(g);
			d = F$1(d, b);
		}
...
(function() {
	...
	C$1.prototype.J = function(a, b, c, d) {
		return this.i.add(String(a), b, !1, c, d);
	};
	C$1.prototype.K = function(a, b, c, d) {
	...
	function Db(a) {
		S$1(a, "zx", Math.floor(Math.random() * 2147483648).toString(36) + Math.abs(Math.floor(Math.random() * 2147483648) ^ Date.now()).toString(36));
		return a;
	}
	function oc(a, b) {
	...
	function Kc(a, b, c) {
		...
		d || (c = Jc(c), typeof a === "string" ? c != null && L$1(c) : S$1(a, b, c));
	}
	function X$1(a) {
		C$1.call(this);
	...
	function Oc(a) {
		a.A || (a.A = !0, D$1(a, "complete"), D$1(a, "error"));
	}
	h.abort = function(a) {
		this.g && this.h && (this.h = !1, this.j = !0, this.g.abort(), this.j = !1, this.o = a || 7, D$1(this, "complete"), D$1(this, "abort"), Pc(this));
	};
	h.N = function() {
	...
	function Qc(a) {
		if (a.h && typeof ea != "undefined") {
			...
			else if (D$1(a, "readystatechange"), P(a) == 4) {
				a.h = !1;
				try {
					const f = a.ca();
					a: switch (f) {
	...
	h.Ea = function(a) {
		if (this.m) if (this.m = null, this.I == 1) {
			if (!a) {
				...
				S$1(c, "RID", a);
				S$1(c, "CVER", 22);
				this.G && S$1(c, "X-HTTP-Session-Id", this.G);
				Uc(this, c);
				f && (this.R ? b = "headers=" + L$1(Jc(f)) + "&" + b : this.u && Kc(c, this.u, f));
				Yb(this.h, e);
				this.Ra && S$1(c, "TYPE", "init");
				this.S ? (S$1(c, "$req", b), S$1(c, "SID", "null"), e.U = !0, Cb(e, c, null)) : Cb(e, c, b);
				this.I = 2;
			}
	...
	H$1.ERROR = "c";
	H$1.MESSAGE = "d";
	C$1.prototype.listen = C$1.prototype.J;
...
//#endregion
//#region node_modules/@firebase/firestore/dist/common-341bda9b.esm.js
/**
* @license
	...
	*/ static fromServerFormat(e) {
		...
		for (; r < e.length;) {
			...
			if ("\\" === t$1) {
				...
				const t$2 = e[r + 1];
				if ("\\" !== t$2 && "." !== t$2 && "`" !== t$2) throw new FirestoreError(C.INVALID_ARGUMENT, "Path has invalid escape sequence: " + e);
				n += t$2, r += 2;
	...
	*/ async L(e) {
		return this.db || (__PRIVATE_logDebug(k, "Opening database:", this.name), this.db = await new Promise(((t, n) => {
			...
			r.onsuccess = (e$1) => {
				...
				"VersionError" === r$1.name ? n(new FirestoreError(C.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : "InvalidStateError" === r$1.name ? n(new FirestoreError(C.FAILED_PRECONDITION, "Unable to open an IndexedDB connection. This could be due to running in a private browsing session on a browser whose private browsing sessions do not support IndexedDB: " + r$1)) : n(new __PRIVATE_IndexedDbTransactionError(e, r$1));
			}, r.onupgradeneeded = (e$1) => {
				__PRIVATE_logDebug(k, "Database \"" + this.name + "\" requires upgrade from version:", e$1.oldVersion);
		...
		}))), this.K && (this.db.onversionchange = (e$1) => this.K(e$1)), this.db;
	}
	q(e) {
	...
	async runTransaction(e, t, n, r) {
		...
		for (;;) {
			...
			try {
				...
				if (__PRIVATE_logDebug(k, "Transaction failed with error:", t$1.message, "Retrying:", n$1), this.close(), !n$1) return Promise.reject(t$1);
			}
		}
	}
	close() {
...
*/ var __PRIVATE_SimpleDbStore = class {
	...
	*/ Z(e, t) {
	...
	X(e, t) {
		...
		return this.J(r, ((e$1, t$1, n$1) => n$1.delete()));
	}
	ee(e, t) {
		let n;
		t ? n = e : (n = {}, t = e);
	...
	re(e) {
		__PRIVATE_logDebug(q, `Scheduled in ${e}ms`), this.task = this.asyncQueue.enqueueAfterDelay("index_backfill", e, (async () => {
			...
			try {
				...
				__PRIVATE_logDebug(q, `Documents written: ${e$1}`);
			} catch (e$1) {
				__PRIVATE_isIndexedDbTransactionError(e$1) ? __PRIVATE_logDebug(q, "Ignoring IndexedDB error during index backfill: ", e$1) : await __PRIVATE_ignoreIfPrimaryLeaseLoss(e$1);
			}
			await this.re(6e4);
		}));
	}
...
/** Implements the steps for backfilling indexes. */ var __PRIVATE_IndexBackfiller = class {
	...
	/** Writes index entries until the cap is reached. Returns the number of documents processed. */ se(e, t) {
		...
		return PersistencePromise.doWhile((() => !0 === i && r > 0), (() => this.localStore.indexManager.getNextCollectionGroupToUpdate(e).next(((t$1) => {
			if (null !== t$1 && !n.has(t$1)) return __PRIVATE_logDebug(q, `Processing collection: ${t$1}`), this.oe(e, t$1, r).next(((e$1) => {
				r -= e$1, n.add(t$1);
			}));
			i = !1;
		})))).next((() => t - r));
	...
	*/ oe(e, t, n) {
		return this.localStore.indexManager.getMinOffsetFromCollectionGroup(e, t).next(((r) => this.localStore.localDocuments.getNextDocuments(e, t, r, n).next(((n$1) => {
			const i = n$1.changes;
			return this.localStore.indexManager.updateIndexEntries(e, i).next((() => this._e(r, n$1))).next(((n$2) => (__PRIVATE_logDebug(q, `Updating offset: ${n$2}`), this.localStore.indexManager.updateCollectionGroup(e, t, n$2)))).next((() => i.size));
		}))));
	}
...
function __PRIVATE_valueCompare(e, t) {
	...
	switch (n) {
		...
		case 10: return function __PRIVATE_compareVectors(e$1, t$1) {
			const n$1 = e$1.fields || {}, r$1 = t$1.fields || {}, i = n$1[ct]?.arrayValue, s = r$1[ct]?.arrayValue, o = __PRIVATE_primitiveComparator(i?.values?.length || 0, s?.values?.length || 0);
			if (0 !== o) return o;
			return __PRIVATE_compareArrays(i, s);
		}(e.mapValue, t.mapValue);
		case 11: return function __PRIVATE_compareMaps(e$1, t$1) {
			if (e$1 === at.mapValue && t$1 === at.mapValue) return 0;
			if (e$1 === at.mapValue) return 1;
			if (t$1 === at.mapValue) return -1;
...
*/ function __PRIVATE_applyTransformOperationToLocalView(e, t, n) {
	return e instanceof __PRIVATE_ServerTimestampTransform ? function serverTimestamp$1(e$1, t$1) {
		...
		return t$1 && __PRIVATE_isServerTimestamp(t$1) && (t$1 = __PRIVATE_getPreviousValue(t$1)), t$1 && (n$1.fields[rt] = t$1), { mapValue: n$1 };
			...
			if (__PRIVATE_targetIsDocumentTarget(i)) if (0 === n) {
				...
				if (r$1 !== n) {
					...
					if (0 !== i$1) {
						...
						this.Ze = this.Ze.insert(t, e$1);
					}
					dt?.lt(function __PRIVATE_createExistenceFilterMismatchInfoForTestingHooks(e$1, t$1, n$2, r$2, i$2) {
						const s = {
							localCacheCount: e$1,
	...
	*/ Tt(e) {
		...
		this.ze.forEach(((n$1, r$1) => {
			...
			if (i) {
				...
				n$1.Be && (t.set(r$1, n$1.ke()), n$1.Ke());
			}
		}));
		let n = __PRIVATE_documentKeySet();
		this.Je.forEach(((e$1, t$1) => {
			let r$1 = !0;
...
function __PRIVATE_fromWatchChange(e, t) {
	...
	if ("targetChange" in t) {
		...
		const r = function __PRIVATE_fromWatchTargetChangeState(e$1) {
			...
			const t$1 = void 0 === e$1.code ? C.UNKNOWN : __PRIVATE_mapCodeFromRpcCode(e$1.code);
	...
	*/
	...
	removeOverlaysForBatchId(e, t, n) {
		...
		return r.forEach(((t$1) => {
			...
			i.push(__PRIVATE_documentOverlayStore(e).X(Ke, r$1));
	...
	getOverlaysForCollection(e, t, n) {
		...
		return __PRIVATE_documentOverlayStore(e).H(Ke, s).next(((e$1) => {
...
*/ var __PRIVATE_IndexedDbGlobalsCache = class {
	...
	getSessionToken(e) {
		return this.St(e).get("sessionToken").next(((e$1) => {
			const t = e$1?.value;
...
*/ var __PRIVATE_OrderedCodeWriter = class {
	...
	/** Writes utf8 bytes into this byte sequence, descending */ Xt(e) {
		for (const t of e) {
			const e$1 = t.charCodeAt(0);
			if (e$1 < 128) this.Ht(e$1);
			else if (e$1 < 2048) this.Ht(960 | e$1 >>> 6), this.Ht(128 | 63 & e$1);
			else if (t < "\ud800" || "\udbff" < t) this.Ht(480 | e$1 >>> 12), this.Ht(128 | 63 & e$1 >>> 6), this.Ht(128 | 63 & e$1);
			else {
				const e$2 = t.codePointAt(0);
				this.Ht(240 | e$2 >>> 18), this.Ht(128 | 63 & e$2 >>> 12), this.Ht(128 | 63 & e$2 >>> 6), this.Ht(128 | 63 & e$2);
			}
		}
		this.Jt();
	}
...
var __PRIVATE_TargetIndexMatcher = class {
	constructor(e) {
		this.Vn = new SortedSet(((e$1, t) => FieldPath$1.comparator(e$1.field, t.field))), this.collectionId = null != e.collectionGroup ? e.collectionGroup : e.path.lastSegment(), this.dn = e.orderBy, this.mn = [];
		for (const t of e.filters) {
			const e$1 = t;
			e$1.isInequality() ? this.Vn = this.Vn.add(e$1) : this.mn.push(e$1);
		}
	}
	get fn() {
	...
	*/ gn(e) {
		...
		if (this.Vn.size > 0) {
			const e$1 = this.Vn.getIterator().getNext();
			if (!r.has(e$1.field.canonicalString())) {
				const t$1 = n[i];
				if (!this.yn(e$1, t$1) || !this.wn(this.dn[s++], t$1)) return !1;
			}
			++i;
		}
		for (; i < n.length; ++i) {
			const e$1 = n[i];
			if (s >= this.dn.length || !this.wn(this.dn[s++], e$1)) return !1;
		}
		return !0;
	}
	/**
...
var __PRIVATE_IndexedDbIndexManager = class {
	constructor(e, t) {
		this.databaseId = t, this.Dn = new __PRIVATE_MemoryCollectionParentIndex(), this.Cn = new ObjectMap(((e$1) => __PRIVATE_canonifyTarget(e$1)), ((e$1, t$1) => __PRIVATE_targetEquals(e$1, t$1))), this.uid = e.uid || "";
	}
	/**
	...
	*/ addToCollectionParentIndex(e, t) {
	...
	getCollectionParents(e, t) {
		...
		return __PRIVATE_collectionParentsStore(e).H(r).next(((e$1) => {
	...
	createTargetIndexes(e, t) {
		return PersistencePromise.forEach(this.vn(t), ((t$1) => this.getIndexType(e, t$1).next(((n) => {
			if (0 === n || 1 === n) {
				const n$1 = new __PRIVATE_TargetIndexMatcher(t$1).bn();
	...
	getDocumentsMatchingTarget(e, t) {
		...
		return PersistencePromise.forEach(this.vn(t), ((t$1) => this.Fn(e, t$1).next(((e$1) => {
			...
			if (r) {
				...
				return PersistencePromise.forEach(i, ((i$1, s) => {
					__PRIVATE_logDebug(wt, `Using index ${function __PRIVATE_fieldIndexToString(e$2) {
					...
					const o = function __PRIVATE_targetGetArrayValues(e$2, t$1) {
						...
						return new Bound(n$1, r$2);
					}(s, i$1), c = this.Mn(i$1, s, a), l = this.Mn(i$1, s, u), h = this.xn(i$1, s, _), P = this.On(i$1.indexId, o, c, a.inclusive, l, u.inclusive, h);
					return PersistencePromise.forEach(P, ((i$2) => n.Z(i$2, t.limit).next(((t$1) => {
						t$1.forEach(((t$2) => {
	...
	*/ On(e, t, n, r, i, s, o) {
		...
		for (let c = 0; c < _; ++c) {
			const _$1 = t ? this.Nn(t[c / a]) : bt, l = this.Bn(e, _$1, n[c % a], r), h = this.Ln(e, _$1, i[c % a], s), P = o.map(((t$1) => this.Bn(e, _$1, t$1, !0)));
	...
	Fn(e, t) {
		...
		return this.getFieldIndexes(e, r).next(((e$1) => {
			let t$1 = null;
			for (const r$1 of e$1) n.gn(r$1) && (!t$1 || r$1.fields.length > t$1.fields.length) && (t$1 = r$1);
			return t$1;
		}));
	}
	getIndexType(e, t) {
		let n = 2;
		const r = this.vn(t);
		return PersistencePromise.forEach(r, ((t$1) => this.Fn(e, t$1).next(((e$1) => {
	...
	*/ kn(e, t) {
		...
		for (const r of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
			...
			const i = n.ln(r.kind);
			__PRIVATE_FirestoreIndexValueWriter.Wt.Dt(e$1, i);
		}
		return n.un();
	}
	...
	*/ Kn(e, t) {
		const n = new __PRIVATE_IndexByteEncoder();
		return __PRIVATE_FirestoreIndexValueWriter.Wt.Dt(__PRIVATE_refValue(this.databaseId, t), n.ln(function __PRIVATE_fieldIndexGetKeyOrder(e$1) {
	...
	*/ xn(e, t, n) {
		...
		for (const s of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
			const e$1 = n[i++];
			for (const n$1 of r) if (this.qn(t, s.fieldPath) && isArray(e$1)) r = this.Un(r, s, e$1);
			else {
				const t$1 = n$1.ln(s.kind);
				__PRIVATE_FirestoreIndexValueWriter.Wt.Dt(e$1, t$1);
			}
		}
		return this.$n(r);
	}
	...
	*/ Un(e, t, n) {
		...
		for (const e$1 of n.arrayValue.values || []) for (const n$1 of r) {
			...
			r$1.seed(n$1.un()), __PRIVATE_FirestoreIndexValueWriter.Wt.Dt(e$1, r$1.ln(t.kind)), i.push(r$1);
		}
		return i;
	}
	qn(e, t) {
	...
	getFieldIndexes(e, t) {
		...
		return (t ? n.H(Se, IDBKeyRange.bound(t, t)) : n.H()).next(((e$1) => {
			const t$1 = [];
	...
	updateCollectionGroup(e, t, n) {
		...
		return this.Wn(e).next(((e$1) => r.H(Se, IDBKeyRange.bound(t, t)).next(((t$1) => PersistencePromise.forEach(t$1, ((t$2) => i.put(__PRIVATE_toDbIndexState(t$2.indexId, this.uid, e$1, n))))))));
	}
	updateIndexEntries(e, t) {
		const n = /* @__PURE__ */ new Map();
		return PersistencePromise.forEach(t, ((t$1, r) => {
			const i = n.get(t$1.collectionGroup);
			return (i ? PersistencePromise.resolve(i) : this.getFieldIndexes(e, t$1.collectionGroup)).next(((i$1) => (n.set(t$1.collectionGroup, i$1), PersistencePromise.forEach(i$1, ((n$1) => this.Qn(e, t$1, n$1).next(((t$2) => {
				const i$2 = this.Gn(r, n$1);
				return t$2.isEqual(i$2) ? PersistencePromise.resolve() : this.zn(e, r, n$1, t$2, i$2);
			})))))));
		}));
	}
	jn(e, t, n, r) {
	...
	/** Creates the index entries for the given document. */ Gn(e, t) {
		...
		if (null != i) {
			...
			if (isArray(s)) for (const i$1 of s.arrayValue.values || []) n = n.add(new __PRIVATE_IndexEntry(t.indexId, e.key, this.Nn(i$1), r));
	...
	*/ createRange(e, t, n) {
		...
		for (const i$1 of n) {
			...
			if (0 === n$1) r[0] = e.En();
			else if (n$1 > 0 && s < 0) r.push(i$1), r.push(i$1.En());
			else if (s > 0) break;
		}
		r.push(t);
		const i = [];
		for (let e$1 = 0; e$1 < r.length; e$1 += 2) {
			if (this.Jn(r[e$1], r[e$1 + 1])) return [];
			const t$1 = r[e$1].An(this.uid, bt, DocumentKey.empty()), n$1 = r[e$1 + 1].An(this.uid, bt, DocumentKey.empty());
	...
	getMinOffset(e, t) {
		return PersistencePromise.mapArray(this.vn(t), ((t$1) => this.Fn(e, t$1).next(((e$1) => e$1 || fail(44426))))).next(__PRIVATE_getMinOffsetFromFieldIndexes);
	}
};
/**
...
var __PRIVATE_IndexedDbMutationQueue = class __PRIVATE_IndexedDbMutationQueue {
	...
	addMutationBatch(e, t, n, r) {
		...
		return s.add({}).next(((o) => {
			...
			for (const e$1 of r) {
				...
				c = c.add(e$1.key.path.popLast()), u.push(s.put(a)), u.push(i.put(t$1, Y));
			}
	...
	*/
	Xn(e, t) {
		return this.Zn[t] ? PersistencePromise.resolve(this.Zn[t]) : this.lookupMutationBatch(e, t).next(((e$1) => {
			if (e$1) {
				const n = e$1.keys();
	...
	getNextMutationBatchAfterBatchId(e, t) {
		...
		return __PRIVATE_mutationsStore(e).ee({
			...
			t$1.userId === this.userId && (__PRIVATE_hardAssert(t$1.batchId >= n, 47524, { Yn: n }), i = __PRIVATE_fromDbMutationBatch(this.serializer, t$1)), r$1.done();
		})).next((() => i));
	}
	...
	getAllMutationBatches(e) {
		...
		return __PRIVATE_mutationsStore(e).H(Z, t).next(((e$1) => e$1.map(((e$2) => __PRIVATE_fromDbMutationBatch(this.serializer, e$2)))));
	}
	...
	performConsistencyCheck(e) {
		return this.checkEmpty(e).next(((t) => {
			...
			return __PRIVATE_documentMutationsStore(e).ee({ range: n }, ((e$1, t$1, n$1) => {
				...
				__PRIVATE_hardAssert(0 === r.length, 56720, { rr: r.map(((e$1) => e$1.canonicalString())) });
			}));
		}));
	}
	containsKey(e, t) {
...
*/ var __PRIVATE_IndexedDbTargetCache = class {
	...
	getLastRemoteSnapshotVersion(e) {
		return this.ur(e).next(((e$1) => SnapshotVersion.fromTimestamp(new Timestamp(e$1.lastRemoteSnapshotVersion.seconds, e$1.lastRemoteSnapshotVersion.nanoseconds))));
	}
	getHighestSequenceNumber(e) {
		return this.ur(e).next(((e$1) => e$1.highestListenSequenceNumber));
	}
	...
	removeTargetData(e, t) {
		return this.removeMatchingKeysForTargetId(e, t.targetId).next((() => __PRIVATE_targetsStore(e).delete(t.targetId))).next((() => this.ur(e))).next(((t$1) => (__PRIVATE_hardAssert(t$1.targetCount > 0, 8065), t$1.targetCount -= 1, this.cr(e, t$1))));
	}
	/**
	...
	*/ forEachTarget(e, t) {
	...
	ur(e) {
		return __PRIVATE_globalTargetStore(e).get(Ee).next(((e$1) => (__PRIVATE_hardAssert(null !== e$1, 2888), e$1)));
	}
	cr(e, t) {
	...
	*/ hr(e, t) {
	...
	getTargetCount(e) {
		return this.ur(e).next(((e$1) => e$1.targetCount));
	}
	getTargetData(e, t) {
	...
	Ar(e) {
		__PRIVATE_logDebug(Ct, `Garbage collection scheduled in ${e}ms`), this.Rr = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection", e, (async () => {
			...
			try {
				...
				__PRIVATE_isIndexedDbTransactionError(e$1) ? __PRIVATE_logDebug(Ct, "Ignoring IndexedDB error during garbage collection: ", e$1) : await __PRIVATE_ignoreIfPrimaryLeaseLoss(e$1);
			}
			await this.Ar(3e5);
		}));
	}
...
*/ var __PRIVATE_LruGarbageCollectorImpl = class {
	...
	calculateTargetCount(e, t) {
		return this.Vr.dr(e).next(((e$1) => Math.floor(t / 100 * e$1)));
	}
	nthSequenceNumber(e, t) {
		...
		return this.Vr.forEachTarget(e, ((e$1) => n.Er(e$1.sequenceNumber))).next((() => this.Vr.mr(e, ((e$1) => n.Er(e$1))))).next((() => n.maxValue));
	}
	removeTargets(e, t, n) {
...
\tRemoved ${e$1} documents in ` + (a - _) + `ms
...
/** Provides LRU functionality for IndexedDB persistence. */ var __PRIVATE_IndexedDbLruDelegateImpl = class {
	...
	*/ wr(e, t) {
	...
	removeOrphanedDocuments(e, t) {
		...
		return this.yr(e, ((s, o) => {
			if (o <= t) {
				const t$1 = this.wr(e, s).next(((t$2) => {
	...
	*/ yr(e, t) {
		...
		return n.ee({ index: Te }, (([e$1, n$1], { path: s, sequenceNumber: o }) => {
...
*/ var __PRIVATE_IndexedDbRemoteDocumentCacheImpl = class {
	...
	*/ Dr(e, t) {
	...
	getEntries(e, t) {
		...
		return this.Cr(e, t, ((e$1, t$1) => {
			const r = this.Sr(e$1, t$1);
			n = n.insert(e$1, r);
		})).next((() => n));
	}
	/**
	...
	*/ vr(e, t) {
	...
	getDocumentsMatchingQuery(e, t, n, r, i) {
		...
		return __PRIVATE_remoteDocumentsStore(e).H(IDBKeyRange.bound(o, _, !0)).next(((e$1) => {
			i?.incrementDocumentReadCount(e$1.length);
			let n$1 = __PRIVATE_mutableDocumentMap();
			for (const i$1 of e$1) {
				const e$2 = this.Sr(DocumentKey.fromSegments(i$1.prefixPath.concat(i$1.collectionGroup, i$1.documentId)), i$1);
	...
	getAllFromCollectionGroup(e, t, n, r) {
		...
		return __PRIVATE_remoteDocumentsStore(e).ee({
			...
			const s$1 = this.Sr(DocumentKey.fromSegments(t$1.prefixPath.concat(t$1.collectionGroup, t$1.documentId)), t$1);
	...
	getMetadata(e) {
		return __PRIVATE_documentGlobalStore(e).get(ae).next(((e$1) => (__PRIVATE_hardAssert(!!e$1, 20021), e$1)));
	}
	br(e, t) {
...
*/ var __PRIVATE_IndexedDbRemoteDocumentChangeBuffer = class extends RemoteDocumentChangeBuffer {
	...
	*/
	constructor(e, t) {
		super(), this.Mr = e, this.trackRemovals = t, this.Or = new ObjectMap(((e$1) => e$1.toString()), ((e$1, t$1) => e$1.isEqual(t$1)));
	}
	applyChanges(e) {
		const t = [];
		...
		return this.changes.forEach(((i, s) => {
			...
			if (t.push(this.Mr.removeEntry(e, i, o.readTime)), s.isValidDocument()) {
				...
				const n$1 = __PRIVATE_toDbRemoteDocument(this.Mr.serializer, s.convertToNoDocument(SnapshotVersion.min()));
				t.push(this.Mr.addEntry(e, i, n$1));
			}
		})), r.forEach(((n$1) => {
			t.push(this.Mr.indexManager.addToCollectionParentIndex(e, n$1));
		})), t.push(this.Mr.updateMetadata(e, n)), PersistencePromise.waitFor(t);
	}
	getFromCache(e, t) {
		return this.Mr.Dr(e, t).next(((e$1) => (this.Or.set(t, {
			size: e$1.size,
			readTime: e$1.document.readTime
		}), e$1.document)));
	}
	getAllFromCache(e, t) {
		return this.Mr.vr(e, t).next((({ documents: e$1, Fr: t$1 }) => (t$1.forEach(((t$2, n) => {
			this.Or.set(t$2, {
				size: n,
...
*/ var __PRIVATE_MemoryBundleCache = class {
	...
	saveNamedQuery(e, t) {
		return this.Br.set(t.name, function __PRIVATE_fromProtoNamedQuery(e$1) {
			return {
				name: e$1.name,
...
*/ var __PRIVATE_MemoryDocumentOverlayCache = class {
	...
	removeOverlaysForBatchId(e, t, n) {
		...
		return void 0 !== r && (r.forEach(((e$1) => this.overlays = this.overlays.remove(e$1))), this.Lr.delete(n)), PersistencePromise.resolve();
	}
	getOverlaysForCollection(e, t, n) {
	...
	bt(e, t, n) {
		...
		if (null !== r) {
			const e$1 = this.Lr.get(r.largestBatchId).delete(n.key);
			this.Lr.set(r.largestBatchId, e$1);
		}
...
*/ var __PRIVATE_ReferenceSet = class {
	...
	*/ Gr(e) {
		...
		return this.qr.forEachInRange([n, r], ((e$1) => {
			this.Wr(e$1), i.push(e$1.key);
		})), i;
	}
	zr() {
...
*/ var __PRIVATE_MemoryMutationQueue = class {
	...
	addMutationBatch(e, t, n, r) {
		...
		for (const t$1 of r) this.Jr = this.Jr.add(new __PRIVATE_DocReference(t$1.key, i)), this.indexManager.addToCollectionParentIndex(e, t$1.key.path.popLast());
	...
	getAllMutationBatchesAffectingDocumentKey(e, t) {
		...
		return this.Jr.forEachInRange([n, r], ((e$1) => {
			const t$1 = this.Zr(e$1.Hr);
			i.push(t$1);
	...
	getAllMutationBatchesAffectingDocumentKeys(e, t) {
		...
		return t.forEach(((e$1) => {
			...
			this.Jr.forEachInRange([t$1, r], ((e$2) => {
				n = n.add(e$2.Hr);
			}));
	...
	getAllMutationBatchesAffectingQuery(e, t) {
		...
		let o = new SortedSet(__PRIVATE_primitiveComparator);
		return this.Jr.forEachWhile(((e$1) => {
			const t$1 = e$1.key.path;
			return !!n.isPrefixOf(t$1) && (t$1.length === r && (o = o.add(e$1.Hr)), !0);
...
*/ var __PRIVATE_MemoryTargetCache = class {
	constructor(e) {
		this.persistence = e, this.ri = new ObjectMap(((e$1) => __PRIVATE_canonifyTarget(e$1)), __PRIVATE_targetEquals), this.lastRemoteSnapshotVersion = SnapshotVersion.min(), this.highestTargetId = 0, this.ii = 0, this.si = new __PRIVATE_ReferenceSet(), this.targetCount = 0, this.oi = __PRIVATE_TargetIdGenerator._r();
	}
	forEachTarget(e, t) {
		return this.ri.forEach(((e$1, n) => t(n))), PersistencePromise.resolve();
	}
	getLastRemoteSnapshotVersion(e) {
...
var __PRIVATE_MemoryPersistence = class {
	...
	*/
	constructor(e, t) {
		...
		}(((e$1) => this.referenceDelegate.hi(e$1))), this.serializer = new __PRIVATE_LocalSerializer(t), this.Pi = new __PRIVATE_MemoryBundleCache(this.serializer);
	}
	start() {
	...
	runTransaction(e, t, n) {
		...
		return this.referenceDelegate.Ti(), n(r).next(((e$1) => this.referenceDelegate.Ii(r).next((() => e$1)))).toPromise().then(((e$1) => (r.raiseOnCommittedEvent(), e$1)));
	}
	Ei(e, t) {
...
var __PRIVATE_MemoryEagerDelegate = class __PRIVATE_MemoryEagerDelegate {
	...
	removeTarget(e, t) {
		this.Ri.Gr(t.targetId).forEach(((e$1) => this.di.add(e$1.toString())));
		const n = this.persistence.getTargetCache();
		return n.getMatchingKeysForTargetId(e, t.targetId).next(((e$1) => {
			e$1.forEach(((e$2) => this.di.add(e$2.toString())));
	...
	Ii(e) {
		...
		return PersistencePromise.forEach(this.di, ((n) => {
			...
			return this.mi(e, r).next(((e$1) => {
				e$1 || t.removeEntry(r, SnapshotVersion.min());
			}));
		})).next((() => (this.Ai = null, t.apply(e))));
	}
	updateLimboDocument(e, t) {
		return this.mi(e, t).next(((e$1) => {
			e$1 ? this.di.delete(t.toString()) : this.di.add(t.toString());
		}));
	}
	hi(e) {
		return 0;
...
var __PRIVATE_MemoryLruDelegate = class __PRIVATE_MemoryLruDelegate {
	constructor(e, t) {
		this.persistence = e, this.fi = new ObjectMap(((e$1) => __PRIVATE_encodeResourcePath(e$1.path)), ((e$1, t$1) => e$1.isEqual(t$1))), this.garbageCollector = __PRIVATE_newLruGarbageCollector(this, t);
	}
	static Vi(e, t) {
	...
	mr(e, t) {
		return PersistencePromise.forEach(this.fi, ((n, r) => this.wr(e, n, r).next(((e$1) => e$1 ? PersistencePromise.resolve() : t(r)))));
	}
	removeTargets(e, t, n) {
	...
	removeOrphanedDocuments(e, t) {
		...
		return r.ni(e, ((r$1) => this.wr(e, r$1, t).next(((e$1) => {
...
/** Performs database creation and schema upgrades. */ var __PRIVATE_SchemaConverter = class {
	...
	*/ k(e, t, n, r) {
		...
		return n < 3 && r >= 3 && (0 !== n && (function __PRIVATE_dropQueryCache(e$1) {
			...
			(function __PRIVATE_createBundlesStore(e$1) {
				e$1.createObjectStore(fe, { keyPath: ge });
			})(e), function __PRIVATE_createNamedQueriesStore(e$1) {
				e$1.createObjectStore(pe, { keyPath: ye });
			}(e);
		}))), n < 12 && r >= 12 && (s = s.next((() => {
			(function __PRIVATE_createDocumentOverlayStore(e$1) {
				const t$1 = e$1.createObjectStore(Le, { keyPath: ke });
				t$1.createIndex(Ke, qe, { unique: !1 }), t$1.createIndex(Ue, $e, { unique: !1 });
			})(e);
		}))), n < 13 && r >= 13 && (s = s.next((() => function __PRIVATE_createRemoteDocumentCache(e$1) {
			const t$1 = e$1.createObjectStore(te, { keyPath: ne });
			t$1.createIndex(re, ie), t$1.createIndex(se, oe);
		}(e))).next((() => this.Si(e, i))).next((() => e.deleteObjectStore(W)))), n < 14 && r >= 14 && (s = s.next((() => this.Di(e, i)))), n < 15 && r >= 15 && (s = s.next((() => function __PRIVATE_createFieldIndex(e$1) {
			e$1.createObjectStore(we, {
				keyPath: be,
				autoIncrement: !0
			}).createIndex(Se, De, { unique: !1 });
			e$1.createObjectStore(Ce, { keyPath: ve }).createIndex(Fe, Me, { unique: !1 });
			e$1.createObjectStore(xe, { keyPath: Oe }).createIndex(Ne, Be, { unique: !1 });
			...
			(function __PRIVATE_createGlobalsStore(e$1) {
				e$1.createObjectStore(We, { keyPath: Qe });
			})(e);
	...
	gi(e) {
		...
		return t.H().next(((t$1) => PersistencePromise.forEach(t$1, ((t$2) => {
			const r = IDBKeyRange.bound([t$2.userId, U], [t$2.userId, t$2.lastAcknowledgedBatchId]);
			return n.H(Z, r).next(((n$1) => PersistencePromise.forEach(n$1, ((n$2) => {
	...
	*/ yi(e) {
		...
		return e.store(Re).get(Ee).next(((e$1) => {
			const r = [];
			return n.ee(((n$1, i) => {
	...
	wi(e, t) {
		...
		const n = t.store(Ae), r = new __PRIVATE_MemoryCollectionParentIndex(), addEntry = (e$1) => {
			if (r.add(e$1)) {
		...
		return t.store(W).ee({ Y: !0 }, ((e$1, t$1) => {
			const n$1 = new ResourcePath(e$1);
			return addEntry(n$1.popLast());
		})).next((() => t.store(ee).ee({ Y: !0 }, (([e$1, t$1, n$1], r$1) => {
	...
	Si(e, t) {
		const n = t.store(W), r = [];
		return n.ee(((e$1, n$1) => {
			const i = t.store(te), s = function __PRIVATE_extractKey(e$2) {
...
var __PRIVATE_IndexedDbPersistence = class __PRIVATE_IndexedDbPersistence {
	...
	*/ $i() {
		return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", ((e) => __PRIVATE_clientMetadataStore(e).put({
			...
			if (this.isPrimary) return this.ji(e).next(((e$1) => {
				e$1 || (this.isPrimary = !1, this.Ci.enqueueRetryable((() => this.ki(!1))));
			}));
	...
	ji(e) {
		return __PRIVATE_primaryClientStore(e).get(G).next(((e$1) => PersistencePromise.resolve(this.Xi(e$1))));
	}
	Yi(e) {
	...
	*/ async es() {
		if (this.isPrimary && !this.ts(this.Li, Mt)) {
			...
			const e = await this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", ((e$1) => {
				const t = __PRIVATE_getStore(e$1, de);
				return t.H().next(((e$2) => {
					const n = this.ns(e$2, Mt), r = e$2.filter(((e$3) => -1 === n.indexOf(e$3)));
	...
	*/ Hi(e) {
		...
		return __PRIVATE_primaryClientStore(e).get(G).next(((t) => {
			...
			return !(!this.networkEnabled || !this.inForeground) || __PRIVATE_clientMetadataStore(e).H().next(((e$1) => void 0 === this.ns(e$1, xt).find(((e$2) => {
		...
		})).next(((e$1) => (this.isPrimary !== e$1 && __PRIVATE_logDebug(Ft, `Client ${e$1 ? "is" : "is not"} eligible for a primary lease.`), e$1)));
	}
	async shutdown() {
	...
	* provided threshold.
	*/ ns(e, t) {
		return e.filter(((e$1) => this.ts(e$1.updateTimeMs, t) && !this.ss(e$1.clientId)));
	}
	/**
	...
	* PORTING NOTE: This is only used for Web multi-tab.
	*/ hs() {
		return this.runTransaction("getActiveClients", "readonly", ((e) => __PRIVATE_clientMetadataStore(e).H().next(((e$1) => this.ns(e$1, Mt).map(((e$2) => e$2.clientId))))));
	}
	get started() {
		return this.ui;
	}
	...
	runTransaction(e, t, n) {
		...
		const r = "readonly" === t ? "readonly" : "readwrite", i = function __PRIVATE_getObjectStores(e$1) {
			return 18 === e$1 ? Ye : 17 === e$1 ? Xe : 16 === e$1 ? Ze : 15 === e$1 ? Je : 14 === e$1 ? He : 13 === e$1 ? je : 12 === e$1 ? ze : 11 === e$1 ? Ge : void fail(60245);
		}(this.xi);
		let s;
		return this.qi.runTransaction(e, r, i, ((r$1) => (s = new __PRIVATE_IndexedDbTransaction(r$1, this.ai ? this.ai.next() : __PRIVATE_ListenSequence.ce), "readwrite-primary" === t ? this.ji(s).next(((e$1) => !!e$1 || this.Hi(s))).next(((t$1) => {
			if (!t$1) throw __PRIVATE_logError(`Failed to obtain primary lease for action '${e}'.`), this.isPrimary = !1, this.Ci.enqueueRetryable((() => this.ki(!1))), new FirestoreError(C.FAILED_PRECONDITION, L);
			return n(s);
		})).next(((e$1) => this.Zi(s).next((() => e$1)))) : this.Ps(s).next((() => n(s)))))).then(((e$1) => (s.raiseOnCommittedEvent(), e$1)));
	}
	/**
	...
	*/
	Ps(e) {
		return __PRIVATE_primaryClientStore(e).get(G).next(((e$1) => {
			if (null !== e$1 && this.ts(e$1.leaseTimestampMs, xt) && !this.ss(e$1.ownerId) && !this.Xi(e$1) && !(this.Mi || this.allowTabSynchronization && e$1.allowTabSynchronization)) throw new FirestoreError(C.FAILED_PRECONDITION, Ot);
		}));
	}
	/**
	...
	*/ Zi(e) {
	...
	/** Checks the primary lease and removes it if we are the current primary. */ Ji(e) {
		...
		return t.get(G).next(((e$1) => this.Xi(e$1) ? (__PRIVATE_logDebug(Ft, "Releasing primary lease."), t.delete(G)) : PersistencePromise.resolve()));
	}
	...
	*/ ss(e) {
		try {
			...
			return __PRIVATE_logError(Ft, "Failed to get zombied client id.", e$1), !1;
		}
	}
	/**
...
var __PRIVATE_QueryEngine = class {
	...
	/** Returns all local documents matching the specified query. */ getDocumentsMatchingQuery(e, t, n, r) {
		const i = { result: null };
		return this.gs(e, t).next(((e$1) => {
			i.result = e$1;
		})).next((() => {
			if (!i.result) return this.ps(e, t, r, n).next(((e$1) => {
				i.result = e$1;
			}));
		})).next((() => {
			if (i.result) return;
			const n$1 = new QueryContext();
			return this.ys(e, t, n$1).next(((r$1) => {
				if (i.result = r$1, this.As) return this.ws(e, t, n$1, r$1.size);
			}));
		})).next((() => i.result));
	}
	ws(e, t, n, r) {
	...
	*/ gs(e, t) {
		...
		return this.indexManager.getIndexType(e, n).next(((r) => 0 === r ? null : (null !== t.limit && 1 === r && (t = __PRIVATE_queryWithLimit(t, null, "F"), n = __PRIVATE_queryToTarget(t)), this.indexManager.getDocumentsMatchingTarget(e, n).next(((r$1) => {
			...
			return this.fs.getDocuments(e, i).next(((r$2) => this.indexManager.getMinOffset(e, n).next(((n$1) => {
				const s = this.bs(t, r$2);
				return this.Ss(t, s, i, n$1.readTime) ? this.gs(e, __PRIVATE_queryWithLimit(t, null, "F")) : this.Ds(e, s, t, n$1);
			}))));
		})))));
	}
	/**
	...
	*/ ps(e, t, n, r) {
		return __PRIVATE_queryMatchesAllDocuments(t) || r.isEqual(SnapshotVersion.min()) ? PersistencePromise.resolve(null) : this.fs.getDocuments(e, n).next(((i) => {
			const s = this.bs(t, i);
			return this.Ss(t, s, n, r) ? PersistencePromise.resolve(null) : (__PRIVATE_getLogLevel() <= LogLevel.DEBUG && __PRIVATE_logDebug("QueryEngine", "Re-using previous result from %s to execute query: %s", r.toString(), __PRIVATE_stringifyQuery(t)), this.Ds(e, s, t, __PRIVATE_newIndexOffsetSuccessorFromReadTime(r, B)).next(((e$1) => e$1)));
		}));
	}
	...
	*/ Ds(e, t, n, r) {
		return this.fs.getDocumentsMatchingQuery(e, n, r).next(((e$1) => (t.forEach(((t$1) => {
...
var __PRIVATE_LocalStoreImpl = class {
	constructor(e, t, n, r) {
		this.persistence = e, this.Cs = t, this.serializer = r, this.vs = new SortedMap(__PRIVATE_primitiveComparator), this.Fs = new ObjectMap(((e$1) => __PRIVATE_canonifyTarget(e$1)), __PRIVATE_targetEquals), this.Ms = /* @__PURE__ */ new Map(), this.xs = e.getRemoteDocumentCache(), this.li = e.getTargetCache(), this.Pi = e.getBundleCache(), this.Os(n);
	}
	Os(e) {
...
async function __PRIVATE_localStoreHandleUserChange(e, t) {
	...
	return await n.persistence.runTransaction("Handle user change", "readonly", ((e$1) => {
		let r;
		return n.mutationQueue.getAllMutationBatches(e$1).next(((i) => (r = i, n.Os(t), n.mutationQueue.getAllMutationBatches(e$1)))).next(((t$1) => {
			const i = [], s = [];
...
function __PRIVATE_localStoreGetLastRemoteSnapshotVersion(e) {
	const t = __PRIVATE_debugCast(e);
	return t.persistence.runTransaction("Get last remote snapshot version", "readonly", ((e$1) => t.li.getLastRemoteSnapshotVersion(e$1)));
}
/**
...
*/ function __PRIVATE_localStoreApplyRemoteEventToLocalCache(e, t) {
	...
	return n.persistence.runTransaction("Apply remote event", "readwrite-primary", ((e$1) => {
		...
		t.targetChanges.forEach(((s$1, _$1) => {
			const a$1 = i.get(_$1);
			if (!a$1) return;
			o.push(n.li.removeMatchingKeys(e$1, s$1.removedDocuments, _$1).next((() => n.li.addMatchingKeys(e$1, s$1.addedDocuments, _$1))));
			...
			null !== t.targetMismatches.get(_$1) ? u = u.withResumeToken(ByteString.EMPTY_BYTE_STRING, SnapshotVersion.min()).withLastLimboFreeSnapshotVersion(SnapshotVersion.min()) : s$1.resumeToken.approximateByteSize() > 0 && (u = u.withResumeToken(s$1.resumeToken, r)), i = i.insert(_$1, u), function __PRIVATE_shouldPersistTargetData(e$2, t$1, n$1) {
				...
				if (t$1.snapshotVersion.toMicroseconds() - e$2.snapshotVersion.toMicroseconds() >= Lt) return !0;
				return n$1.addedDocuments.size + n$1.modifiedDocuments.size + n$1.removedDocuments.size > 0;
			}(a$1, u, s$1) && o.push(n.li.updateTargetData(e$1, u));
		}));
		...
		if (t.documentUpdates.forEach(((r$1) => {
			...
			const t$1 = n.li.getLastRemoteSnapshotVersion(e$1).next(((t$2) => n.li.setTargetsMetadata(e$1, e$1.currentSequenceNumber, r)));
			o.push(t$1);
		}
...
function __PRIVATE_localStoreGetNextMutationBatch(e, t) {
	const n = __PRIVATE_debugCast(e);
	return n.persistence.runTransaction("Get next mutation batch", "readonly", ((e$1) => (void 0 === t && (t = U), n.mutationQueue.getNextMutationBatchAfterBatchId(e$1, t))));
}
/**
...
function __PRIVATE_localStoreAllocateTarget(e, t) {
	...
	return n.persistence.runTransaction("Allocate target", "readwrite", ((e$1) => {
		let r;
		return n.li.getTargetData(e$1, t).next(((i) => i ? (r = i, PersistencePromise.resolve(r)) : n.li.allocateTargetId(e$1).next(((i$1) => (r = new TargetData(t, i$1, "TargetPurposeListen", e$1.currentSequenceNumber), n.li.addTargetData(e$1, r).next((() => r)))))));
	})).then(((e$1) => {
		const r = n.vs.get(e$1.targetId);
		return (null === r || e$1.snapshotVersion.compareTo(r.snapshotVersion) > 0) && (n.vs = n.vs.insert(e$1.targetId, e$1), n.Fs.set(t, e$1.targetId)), e$1;
	}));
}
/**
...
async function __PRIVATE_localStoreReleaseTarget(e, t, n) {
	...
	try {
		...
		__PRIVATE_logDebug(Bt, `Failed to update sequence numbers for target ${t}: ${e$1}`);
	}
...
*/ function __PRIVATE_localStoreExecuteQuery(e, t, n) {
	...
	return r.persistence.runTransaction("Execute query", "readwrite", ((e$1) => function __PRIVATE_localStoreGetTargetData(e$2, t$1, n$1) {
		const r$1 = __PRIVATE_debugCast(e$2), i$1 = r$1.Fs.get(n$1);
		return void 0 !== i$1 ? PersistencePromise.resolve(r$1.vs.get(i$1)) : r$1.li.getTargetData(t$1, n$1);
	}(r, e$1, __PRIVATE_queryToTarget(t)).next(((t$1) => {
		if (t$1) return i = t$1.lastLimboFreeSnapshotVersion, r.li.getMatchingKeysForTargetId(e$1, t$1.targetId).next(((e$2) => {
			s = e$2;
		}));
	})).next((() => r.Cs.getDocumentsMatchingQuery(e$1, t, n ? i : SnapshotVersion.min(), n ? s : __PRIVATE_documentKeySet()))).next(((e$2) => (__PRIVATE_setMaxReadTime(r, __PRIVATE_queryCollectionGroup(t), e$2), {
		documents: e$2,
		ks: s
	})))));
}
...
function __PRIVATE_localStoreGetNewDocumentChanges(e, t) {
	...
	return n.persistence.runTransaction("Get new document changes", "readonly", ((e$1) => n.xs.getAllFromCollectionGroup(e$1, t, __PRIVATE_newIndexOffsetSuccessorFromReadTime(r, B), Number.MAX_SAFE_INTEGER))).then(((e$1) => (__PRIVATE_setMaxReadTime(n, t, e$1), e$1)));
}
...
async function __PRIVATE_localStoreApplyBundledDocuments(e, t, n, r) {
	...
	for (const e$1 of n) {
		const n$1 = t.Ks(e$1.metadata.name);
		e$1.document && (s = s.add(n$1));
		const r$1 = t.qs(e$1);
		r$1.setReadTime(t.Us(e$1.metadata.readTime)), o = o.insert(n$1, r$1);
	}
	const _ = i.xs.newChangeBuffer({ trackRemovals: !0 }), a = await __PRIVATE_localStoreAllocateTarget(i, function __PRIVATE_umbrellaTarget(e$1) {
		return __PRIVATE_queryToTarget(__PRIVATE_newQueryForPath(ResourcePath.fromString(`__bundle__/docs/${e$1}`)));
	}(r));
	return i.persistence.runTransaction("Apply bundle documents", "readwrite", ((e$1) => __PRIVATE_populateDocumentChangeBuffer(e$1, _, o).next(((t$1) => (_.apply(e$1), t$1))).next(((t$1) => i.li.removeMatchingKeysForTargetId(e$1, a.targetId).next((() => i.li.addMatchingKeys(e$1, s, a.targetId))).next((() => i.localDocuments.getLocalViewOfDocuments(e$1, t$1.Bs, t$1.Ls))).next((() => t$1.Bs))))));
}
/**
...
async function __PRIVATE_localStoreSaveNamedQuery(e, t, n = __PRIVATE_documentKeySet()) {
	...
	return i.persistence.runTransaction("Save named query", "readwrite", ((e$1) => {
		...
		if (r.snapshotVersion.compareTo(s) >= 0) return i.Pi.saveNamedQuery(e$1, t);
		const o = r.withResumeToken(ByteString.EMPTY_BYTE_STRING, s);
		return i.vs = i.vs.insert(o.targetId, o), i.li.updateTargetData(e$1, o).next((() => i.li.removeMatchingKeysForTargetId(e$1, r.targetId))).next((() => i.li.addMatchingKeys(e$1, n, r.targetId))).next((() => i.Pi.saveNamedQuery(e$1, t)));
	}));
}
/**
* @license
...
*/ var __PRIVATE_WebStorageSharedClientState = class {
	constructor(e, t, n, r, i) {
		...
		const s = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
		this.storage = this.window.localStorage, this.currentUser = i, this.Xs = createWebStorageClientStateKey(this.persistenceKey, this.zs), this.Ys = function createWebStorageSequenceNumberKey(e$1) {
			return `firestore_sequence_number_${e$1}`;
		}(this.persistenceKey), this.Js = this.Js.insert(this.zs, new __PRIVATE_LocalClientState()), this.eo = /* @__PURE__ */ new RegExp(`^${kt}_${s}_([^_]*)$`), this.no = /* @__PURE__ */ new RegExp(`^${Kt$1}_${s}_(\\d+)(?:_(.*))?$`), this.ro = /* @__PURE__ */ new RegExp(`^${qt}_${s}_(\\d+)$`), this.io = function createWebStorageOnlineStateKey(e$1) {
			return `firestore_online_state_${e$1}`;
		}(this.persistenceKey), this.so = function createBundleLoadedKey(e$1) {
	...
	async start() {
		...
		for (const e$1 of this.Zs) this.Hs(e$1);
	...
	addLocalQueryTarget(e, t = !0) {
		...
		if (this.isActiveQueryTarget(e)) {
			...
			if (t$1) {
				const r = __PRIVATE_QueryTargetMetadata.$s(e, t$1);
				r && (n = r.state);
			}
		}
				...
				if (this.started) {
					if (null !== t.key) {
						if (this.eo.test(t.key)) {
							if (null == t.newValue) {
								const e$1 = this.Eo(t.key);
								return this.Ro(e$1, null);
							}
							{
								const e$1 = this.Ao(t.key, t.newValue);
								if (e$1) return this.Ro(e$1.clientId, e$1);
							}
						} else if (this.no.test(t.key)) {
							if (null !== t.newValue) {
								const e$1 = this.Vo(t.key, t.newValue);
								if (e$1) return this.mo(e$1);
							}
							...
							if (null !== t.newValue) {
								const e$1 = this._o(t.newValue);
								if (e$1) return this.ao(e$1);
							}
							...
							const e$1 = function __PRIVATE_fromWebStorageSequenceNumber(e$2) {
								...
								if (null != e$2) try {
									...
									__PRIVATE_hardAssert("number" == typeof n, 30636, { yo: e$2 }), t$1 = n;
								} catch (e$3) {
									__PRIVATE_logError(Ut$1, "Failed to read sequence number from WebStorage", e$3);
								}
								return t$1;
							}(t.newValue);
							e$1 !== __PRIVATE_ListenSequence.ce && this.sequenceNumberHandler(e$1);
						} else if (t.key === this.so) {
							const e$1 = this.wo(t.newValue);
							await Promise.all(e$1.map(((e$2) => this.syncEngine.bo(e$2))));
						}
					}
				} else this.Zs.push(t);
			}));
...
var __PRIVATE_RestConnection = class {
	...
	Wo(e, t, n, r, i) {
		...
		return this.zo(e, o, _, n, c).then(((t$1) => (__PRIVATE_logDebug(Qt, `Received RPC '${e}' ${s}: `, t$1), t$1)), ((t$1) => {
			throw __PRIVATE_logWarn(Qt, `RPC '${e}' ${s} failed with error: `, t$1, "url: ", o, "request:", n), t$1;
		}));
	}
	jo(e, t, n, r, i, s) {
...
var __PRIVATE_WebChannelConnection = class __PRIVATE_WebChannelConnection extends __PRIVATE_RestConnection {
	...
	*/ static u_() {
		if (!__PRIVATE_WebChannelConnection.c_) {
			...
			__PRIVATE_unguardedEventListen(e, Event.STAT_EVENT, ((e$1) => {
				e$1.stat === Stat.PROXY ? __PRIVATE_logDebug(zt$1, "STAT_EVENT: detected buffering proxy") : e$1.stat === Stat.NOPROXY && __PRIVATE_logDebug(zt$1, "STAT_EVENT: detected no buffering proxy");
				...
				try {
					switch (_.getLastErrorCode()) {
						case ErrorCode.NO_ERROR:
							...
							__PRIVATE_logDebug(zt$1, `XHR for RPC '${e}' ${s} received:`, JSON.stringify(t$1)), i$1(t$1);
							break;
						...
						case ErrorCode.HTTP_ERROR:
							...
							if (__PRIVATE_logDebug(zt$1, `RPC '${e}' ${s} failed with status:`, n$1, "response text:", _.getResponseText()), n$1 > 0) {
								...
								if (t$2 && t$2.status && t$2.message) {
									const e$2 = function __PRIVATE_mapCodeFromHttpResponseErrorStatus(e$3) {
										...
										return Object.values(C).indexOf(t$3) >= 0 ? t$3 : C.UNKNOWN;
									}(t$2.status);
	...
	T_(e, t, n) {
		...
		const h = new __PRIVATE_StreamBridge({
			Ho: (t$1) => {
				l ? __PRIVATE_logDebug(zt$1, `Not sending because RPC '${e}' stream ${r} is closed:`, t$1) : (c || (__PRIVATE_logDebug(zt$1, `Opening RPC '${e}' stream ${r} transport.`), u.open(), c = !0), __PRIVATE_logDebug(zt$1, `RPC '${e}' stream ${r} sending:`, t$1), u.send(t$1));
			},
			Jo: () => u.close()
		});
		...
		})), __PRIVATE_unguardedEventListen(u, WebChannel.EventType.ERROR, ((t$1) => {
			l || (l = !0, __PRIVATE_logWarn(zt$1, `RPC '${e}' stream ${r} transport errored. Name:`, t$1.name, "Message:", t$1.message), h.o_(new FirestoreError(C.UNAVAILABLE, "The operation could not be completed")));
		})), __PRIVATE_unguardedEventListen(u, WebChannel.EventType.MESSAGE, ((t$1) => {
			if (!l) {
				const n$1 = t$1.data[0];
				__PRIVATE_hardAssert(!!n$1, 16349);
				const i$1 = n$1, s$1 = i$1?.error || i$1[0]?.error;
				if (s$1) {
					__PRIVATE_logDebug(zt$1, `RPC '${e}' stream ${r} received error:`, s$1);
					...
					void 0 === n$2 && (n$2 = C.INTERNAL, i$2 = "Unknown error status: " + t$2 + " with message " + s$1.message), l = !0, h.o_(new FirestoreError(n$2, i$2)), u.close();
				} else __PRIVATE_logDebug(zt$1, `RPC '${e}' stream ${r} received:`, n$1), h.__(n$1);
			}
	...
	*/ W_() {}
	auth() {
		...
		Promise.all([this.authCredentialsProvider.getToken(), this.appCheckCredentialsProvider.getToken()]).then((([e$1, n]) => {
			...
			e((() => {
				const e$1 = new FirestoreError(C.UNKNOWN, "Fetching auth token failed: " + t$1.message);
				return this.z_(e$1);
			}));
		}));
	}
	G_(e, t) {
		...
		this.stream = this.j_(e, t), this.stream.Zo((() => {
			...
			n((() => 1 == ++this.F_ ? this.H_(e$1) : this.onNext(e$1)));
		}));
	}
	N_() {
...
*/ var __PRIVATE_DatastoreImpl = class extends Datastore {
	...
	/** Invokes the provided RPC with auth and AppCheck tokens. */ Wo(e, t, n, r) {
		return this.sa(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then((([i, s]) => this.connection.Wo(e, __PRIVATE_toResourcePath(t, n), r, i, s))).catch(((e$1) => {
			throw "FirebaseError" === e$1.name ? (e$1.code === C.UNAUTHENTICATED && (this.authCredentials.invalidateToken(), this.appCheckCredentials.invalidateToken()), e$1) : new FirestoreError(C.UNKNOWN, e$1.toString());
		}));
	}
	/** Invokes the provided RPC with streamed results with auth and AppCheck tokens. */ jo(e, t, n, r, i) {
		return this.sa(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then((([s, o]) => this.connection.jo(e, __PRIVATE_toResourcePath(t, n), r, s, o, i))).catch(((e$1) => {
			throw "FirebaseError" === e$1.name ? (e$1.code === C.UNAUTHENTICATED && (this.authCredentials.invalidateToken(), this.appCheckCredentials.invalidateToken()), e$1) : new FirestoreError(C.UNKNOWN, e$1.toString());
		}));
	}
	terminate() {
...
var __PRIVATE_RemoteStoreImpl = class {
	constructor(e, t, n, r, i) {
		this.localStore = e, this.datastore = t, this.asyncQueue = n, this.remoteSyncer = {}, this.Ta = [], this.Ia = /* @__PURE__ */ new Map(), this.Ea = /* @__PURE__ */ new Set(), this.Ra = [], this.Aa = i, this.Aa.Mo(((e$1) => {
			n.enqueueAndForget((async () => {
				__PRIVATE_canUseNetwork(this) && (__PRIVATE_logDebug(Ht$1, "Restarting streams for network reachability change."), await async function __PRIVATE_restartNetwork(e$2) {
					const t$1 = __PRIVATE_debugCast(e$2);
					t$1.Ea.add(4), await __PRIVATE_disableNetworkInternal(t$1), t$1.Va.set("Unknown"), t$1.Ea.delete(4), await __PRIVATE_enableNetworkInternal(t$1);
				}(this));
			}));
...
async function __PRIVATE_onWatchStreamChange(e, t, n) {
	if (e.Va.set("Online"), t instanceof __PRIVATE_WatchTargetChange && 2 === t.state && t.cause) try {
		...
		await async function __PRIVATE_handleTargetError(e$1, t$1) {
			const n$1 = t$1.cause;
			for (const r of t$1.targetIds) e$1.Ia.has(r) && (await e$1.remoteSyncer.rejectListen(r, n$1), e$1.Ia.delete(r), e$1.da.removeTarget(r));
		}(e, t);
	} catch (n$1) {
		__PRIVATE_logDebug(Ht$1, "Failed to remove targets %s: %s ", t.targetIds.join(","), n$1), await __PRIVATE_disableNetworkUntilRecovery(e, n$1);
	}
		...
		__PRIVATE_logDebug(Ht$1, "Failed to raise snapshot:", t$1), await __PRIVATE_disableNetworkUntilRecovery(e, t$1);
	}
}
/**
...
async function __PRIVATE_onWriteStreamClose(e, t) {
	t && __PRIVATE_ensureWriteStream(e).Y_ && await async function __PRIVATE_handleWriteError(e$1, t$1) {
		if (function __PRIVATE_isPermanentWriteError(e$2) {
			return __PRIVATE_isPermanentError(e$2) && e$2 !== C.ABORTED;
		}(t$1.code)) {
	...
	terminate() {
		(function __PRIVATE_errorAllTargets(e, t) {
			...
			n.queries = __PRIVATE_newQueriesObjectMap(), r.forEach(((e$1, n$1) => {
				for (const e$2 of n$1.ba) e$2.onError(t);
			}));
...
async function __PRIVATE_eventManagerUnlisten(e, t) {
	...
	if (s) {
		const e$1 = s.ba.indexOf(t);
		e$1 >= 0 && (s.ba.splice(e$1, 1), 0 === s.ba.length ? i = t.Da() ? 0 : 1 : !s.Sa() && t.Da() && (i = 2));
	}
	switch (i) {
...
function __PRIVATE_eventManagerOnWatchChange(e, t) {
	...
	for (const e$1 of t) {
		...
		if (i) {
			for (const t$2 of i.ba) t$2.Fa(e$1) && (r = !0);
			i.wa = e$1;
		}
	}
...
function __PRIVATE_eventManagerOnWatchError(e, t, n) {
	...
	if (i) for (const e$1 of i.ba) e$1.onError(n);
	r.queries.delete(t);
}
...
*/ var __PRIVATE_BundleLoader = class {
	...
	*/ Ga(e) {
	...
	za(e) {
		...
		for (const r of e) if (r.metadata.queries) {
			const e$1 = n.Ks(r.metadata.name);
	...
	*/ async ja(e) {
		...
		for (const t$1 of this.Wa) await __PRIVATE_localStoreSaveNamedQuery(e, t$1, n.get(t$1.name));
...
*/ var __PRIVATE_View = class {
		...
		s.sort(((e$1, t$1) => function __PRIVATE_compareChangeType(e$2, t$2) {
			const order = (e$3) => {
				switch (e$3) {
					...
					case 3: return 2;
					case 1: return 0;
					default: return fail(20277, { Vt: e$3 });
				}
			};
	...
	*/ ou(e) {
		e && (e.addedDocuments.forEach(((e$1) => this.Za = this.Za.add(e$1))), e.modifiedDocuments.forEach(((e$1) => {})), e.removedDocuments.forEach(((e$1) => this.Za = this.Za.delete(e$1))), this.current = e.current);
	}
	_u() {
		if (!this.current) return [];
		const e = this.Ya;
		this.Ya = __PRIVATE_documentKeySet(), this.tu.forEach(((e$1) => {
			this.uu(e$1.key) && (this.Ya = this.Ya.add(e$1.key));
		}));
		const t = [];
		return e.forEach(((e$1) => {
			this.Ya.has(e$1) || t.push(new __PRIVATE_RemovedLimboDocument(e$1));
		})), this.Ya.forEach(((n) => {
...
*/ var __PRIVATE_SyncEngineImpl = class {
	constructor(e, t, n, r, i, s) {
		this.localStore = e, this.remoteStore = t, this.eventManager = n, this.sharedClientState = r, this.currentUser = i, this.maxConcurrentLimboResolutions = s, this.Pu = {}, this.Tu = new ObjectMap(((e$1) => __PRIVATE_canonifyQuery(e$1)), __PRIVATE_queryEquals), this.Iu = /* @__PURE__ */ new Map(), this.Eu = /* @__PURE__ */ new Set(), this.Ru = new SortedMap(DocumentKey.comparator), this.Au = /* @__PURE__ */ new Map(), this.Vu = new __PRIVATE_ReferenceSet(), this.du = {}, this.mu = /* @__PURE__ */ new Map(), this.fu = __PRIVATE_TargetIdGenerator.ar(), this.onlineState = "Unknown", this.gu = void 0;
	}
	get isPrimaryClient() {
		return !0 === this.gu;
	}
...
*/ async function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, r, i) {
	e.pu = (t$1, n$1, r$1) => async function __PRIVATE_applyDocChanges(e$1, t$2, n$2, r$2) {
		...
		i$1.Ss && (i$1 = await __PRIVATE_localStoreExecuteQuery(e$1.localStore, t$2.query, !1).then((({ documents: e$2 }) => t$2.view.ru(e$2, i$1))));
	...
	try {
		const e$1 = await function __PRIVATE_localStoreWriteLocally(e$2, t$1) {
			...
			return n$1.persistence.runTransaction("Locally write mutations", "readwrite", ((e$3) => {
				let _ = __PRIVATE_mutableDocumentMap(), a = __PRIVATE_documentKeySet();
				return n$1.xs.getEntries(e$3, i).next(((e$4) => {
		...
		r.sharedClientState.addPendingMutation(e$1.batchId), function __PRIVATE_addMutationCallback(e$2, t$1, n$1) {
			let r$1 = e$2.du[e$2.currentUser.toKey()];
			r$1 || (r$1 = new SortedMap(__PRIVATE_primitiveComparator));
			r$1 = r$1.insert(t$1, n$1), e$2.du[e$2.currentUser.toKey()] = r$1;
	...
	if (r.isPrimaryClient && 0 === n || !r.isPrimaryClient && 1 === n) {
		...
		r.Tu.forEach(((n$1, r$1) => {
			...
			n$1.queries.forEach(((e$3, n$2) => {
				for (const e$4 of n$2.ba) e$4.va(t$1) && (r$1 = !0);
			})), r$1 && __PRIVATE_raiseSnapshotsInSyncEvent(n$1);
		}(r.eventManager, t), e$1.length && r.Pu.J_(e$1), r.onlineState = t, r.isPrimaryClient && r.sharedClientState.setOnlineState(t);
	}
}
/**
...
*/ async function __PRIVATE_syncEngineRejectListen(e, t, n) {
	...
	if (s) {
		...
		await __PRIVATE_syncEngineApplyRemoteEvent(r, i$1), r.Ru = r.Ru.remove(s), r.Au.delete(t), __PRIVATE_pumpEnqueuedLimboResolutions(r);
...
*/ async function __PRIVATE_syncEngineRegisterPendingWritesCallback(e, t) {
	...
	try {
		...
		if (e$1 === U) return void t.resolve();
...
/** Reject all outstanding callbacks waiting for pending writes to complete. */ function __PRIVATE_processUserCallback(e, t, n) {
	...
	if (i) {
		const e$1 = i.get(t);
		e$1 && (n ? e$1.reject(n) : e$1.resolve(), i = i.remove(t)), r.du[r.currentUser.toKey()] = i;
	}
}
function __PRIVATE_removeAndCleanupTarget(e, t, n = null) {
	e.sharedClientState.removeLocalQueryTarget(t);
	for (const r of e.Iu.get(t)) e.Tu.delete(r), n && e.Pu.yu(r, n);
	if (e.Iu.delete(t), e.isPrimaryClient) e.Vu.Gr(t).forEach(((t$1) => {
		e.Vu.containsKey(t$1) || __PRIVATE_removeLimboTarget(e, t$1);
	}));
}
...
async function __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(e, t, n) {
	...
	r.Tu.isEmpty() || (r.Tu.forEach(((e$1, _) => {
		o.push(r.pu(_, t, n).then(((e$2) => {
			...
			if (e$2) {
				i.push(e$2);
				const t$1 = __PRIVATE_LocalViewChanges.Es(_.targetId, e$2);
				s.push(t$1);
			}
		})));
	})), await Promise.all(o), r.Pu.J_(i), await async function __PRIVATE_localStoreNotifyLocalViewChanges(e$1, t$1) {
		const n$1 = __PRIVATE_debugCast(e$1);
		try {
			await n$1.persistence.runTransaction("notifyLocalViewChanges", "readwrite", ((e$2) => PersistencePromise.forEach(t$1, ((t$2) => PersistencePromise.forEach(t$2.Ts, ((r$1) => n$1.persistence.referenceDelegate.addReference(e$2, t$2.targetId, r$1))).next((() => PersistencePromise.forEach(t$2.Is, ((r$1) => n$1.persistence.referenceDelegate.removeReference(e$2, t$2.targetId, r$1)))))))));
		} catch (e$2) {
			if (!__PRIVATE_isIndexedDbTransactionError(e$2)) throw e$2;
			__PRIVATE_logDebug(Bt, "Failed to update sequence numbers: " + e$2);
		}
		for (const e$2 of t$1) {
			const t$2 = e$2.targetId;
			if (!e$2.fromCache) {
				const e$3 = n$1.vs.get(t$2), r$1 = e$3.snapshotVersion, i$1 = e$3.withLastLimboFreeSnapshotVersion(r$1);
				n$1.vs = n$1.vs.insert(t$2, i$1);
			}
		}
	}(r.localStore, s));
}
async function __PRIVATE_syncEngineHandleCredentialChange(e, t) {
	...
	if (!n.currentUser.isEqual(t)) {
		...
		n.currentUser = t, function __PRIVATE_rejectOutstandingPendingWritesCallbacks(e$2, t$1) {
			e$2.mu.forEach(((e$3) => {
				e$3.forEach(((e$4) => {
					e$4.reject(new FirestoreError(C.CANCELLED, t$1));
				}));
			})), e$2.mu.clear();
		}(n, "'waitForPendingWrites' promise is rejected due to a user change."), n.sharedClientState.handleUserChange(t, e$1.removedBatchIds, e$1.addedBatchIds), await __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(n, e$1.Ns);
	}
}
...
async function __PRIVATE_syncEngineApplyBatchState(e, t, n, r) {
	const i = __PRIVATE_debugCast(e), s = await function __PRIVATE_localStoreLookupMutationDocuments(e$1, t$1) {
		...
		return n$1.persistence.runTransaction("Lookup mutation documents", "readonly", ((e$2) => r$1.Xn(e$2, t$1).next(((t$2) => t$2 ? n$1.localDocuments.getDocuments(e$2, t$2) : PersistencePromise.resolve(null)))));
	}(i.localStore, t);
	null !== s ? ("pending" === n ? await __PRIVATE_fillWritePipeline(i.remoteStore) : "acknowledged" === n || "rejected" === n ? (__PRIVATE_processUserCallback(i, t, r || null), __PRIVATE_triggerPendingWritesCallbacks(i, t), function __PRIVATE_localStoreRemoveCachedMutationBatchMetadata(e$1, t$1) {
		__PRIVATE_debugCast(__PRIVATE_debugCast(e$1).mutationQueue).nr(t$1);
...
async function __PRIVATE_syncEngineApplyPrimaryState(e, t) {
	...
	if (__PRIVATE_ensureWatchCallbacks(n), __PRIVATE_syncEngineEnsureWriteCallbacks(n), !0 === t && !0 !== n.gu) {
		...
		n.Iu.forEach(((r, i) => {
			...
			})), t$2.Vu.zr(), t$2.Au = /* @__PURE__ */ new Map(), t$2.Ru = new SortedMap(DocumentKey.comparator);
...
function __PRIVATE_syncEngineGetActiveClients(e) {
	return function __PRIVATE_localStoreGetActiveClients(e$1) {
		return __PRIVATE_debugCast(__PRIVATE_debugCast(e$1).persistence).hs();
	...
	if (r.gu) {
		for (const e$1 of t) {
			if (r.Iu.has(e$1) && r.sharedClientState.isActiveQueryTarget(e$1)) {
				__PRIVATE_logDebug(Xt$1, "Adding an already active target " + e$1);
				continue;
			}
	...
	(async function __PRIVATE_loadBundleImpl(e$1, t$1, n$1) {
		try {
			...
			if (await function __PRIVATE_localStoreHasNewerBundle(e$2, t$2) {
				...
				return n$2.persistence.runTransaction("hasNewerBundle", "readonly", ((e$3) => n$2.Pi.getBundleMetadata(e$3, t$2.id))).then(((e$3) => !!e$3 && e$3.createTime.compareTo(r$2) >= 0));
			...
			for (; s;) {
				...
				e$2 && n$1._updateProgress(e$2), s = await t$1.Su();
			}
			const o = await i.ja(e$1.localStore);
			return await __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(e$1, o.Ja, void 0), await function __PRIVATE_localStoreSaveBundle(e$2, t$2) {
				const n$2 = __PRIVATE_debugCast(e$2);
				return n$2.persistence.runTransaction("Save bundle", "readwrite", ((e$3) => n$2.Pi.saveBundleMetadata(e$3, t$2)));
			}(e$1.localStore, r$1), n$1._completeWith(o.progress), Promise.resolve(o.Ha);
		} catch (e$2) {
			return __PRIVATE_logWarn(Xt$1, `Loading bundle failed with ${e$2}`), n$1._failWith(e$2), Promise.resolve(/* @__PURE__ */ new Set());
		}
	})(r, t, n).then(((e$1) => {
...
var __PRIVATE_LruGcMemoryOfflineComponentProvider = class extends __PRIVATE_MemoryOfflineComponentProvider {
	...
	Cu(e) {
		...
		return new __PRIVATE_MemoryPersistence(((e$1) => __PRIVATE_MemoryLruDelegate.Vi(e$1, t)), this.serializer);
	}
};
/**
...
*/ var __PRIVATE_MultiTabOfflineComponentProvider = class extends __PRIVATE_IndexedDbOfflineComponentProvider {
	...
	async initialize(e) {
		...
		}, await this.sharedClientState.start()), await this.persistence.zi((async (e$1) => {
...
*/ var __PRIVATE_BundleReaderImpl = class {
	constructor(e, t) {
		this.Bu = e, this.serializer = t, this.metadata = new __PRIVATE_Deferred(), this.buffer = new Uint8Array(), this.Lu = function __PRIVATE_newTextDecoder() {
			...
			e$1 && e$1.Ua() ? this.metadata.resolve(e$1.qa.metadata) : this.metadata.reject(/* @__PURE__ */ new Error(`The first element of the bundle is not a metadata, it is\n             ${JSON.stringify(e$1?.qa)}`));
...
var Transaction$2 = class {
	...
	async lookup(e) {
		...
		const t = await async function __PRIVATE_invokeBatchGetDocumentsRpc(e$1, t$1) {
			const n = __PRIVATE_debugCast(e$1), r = { documents: t$1.map(((e$2) => __PRIVATE_toName(n.serializer, e$2))) }, i = await n.jo("BatchGetDocuments", n.serializer.databaseId, ResourcePath.emptyPath(), r, t$1.length), s = /* @__PURE__ */ new Map();
			i.forEach(((e$2) => {
...
var FirestoreClient = class {
	constructor(e, t, n, r, i) {
		this.authCredentials = e, this.appCheckCredentials = t, this.asyncQueue = n, this._databaseInfo = r, this.user = User.UNAUTHENTICATED, this.clientId = __PRIVATE_AutoId.newId(), this.authCredentialListener = () => Promise.resolve(), this.appCheckCredentialListener = () => Promise.resolve(), this._uninitializedComponentsProvider = i, this.authCredentials.start(n, (async (e$1) => {
			__PRIVATE_logDebug(Yt$1, "Received user=", e$1.uid), await this.authCredentialListener(e$1), this.user = e$1;
		})), this.appCheckCredentials.start(n, ((e$1) => (__PRIVATE_logDebug(Yt$1, "Received new app check token=", e$1), this.appCheckCredentialListener(e$1, this.user))));
	}
	get configuration() {
		return {
...
async function __PRIVATE_setOnlineComponentProvider(e, t) {
	...
	__PRIVATE_logDebug(Yt$1, "Initializing OnlineComponentProvider"), await t.initialize(n, e.configuration), e.setCredentialChangeListener(((e$1) => __PRIVATE_remoteStoreHandleCredentialChange(t.remoteStore, e$1))), e.setAppCheckTokenChangeListener(((e$1, n$1) => __PRIVATE_remoteStoreHandleCredentialChange(t.remoteStore, n$1))), e._onlineComponents = t;
}
/**
	...
	if (!e._offlineComponents) if (e._uninitializedComponentsProvider) {
		...
		try {
			...
			if (!function __PRIVATE_canFallbackFromIndexedDbError(e$1) {
				return "FirebaseError" === e$1.name ? e$1.code === C.FAILED_PRECONDITION || e$1.code === C.UNIMPLEMENTED : !("undefined" != typeof DOMException && e$1 instanceof DOMException) || 22 === e$1.code || 20 === e$1.code || 11 === e$1.code;
			}(n)) throw n;
...
/** Disables the network connection. Pending operations will not complete. */ function __PRIVATE_firestoreClientDisableNetwork(e) {
	return e.asyncQueue.enqueue((async () => {
		...
		return t.setNetworkEnabled(!1), async function __PRIVATE_remoteStoreDisableNetwork(e$1) {
			const t$1 = __PRIVATE_debugCast(e$1);
			t$1.Ea.add(0), await __PRIVATE_disableNetworkInternal(t$1), t$1.Va.set("Offline");
		}(n);
	}));
}
/**
...
function __PRIVATE_firestoreClientGetDocumentFromLocalCache(e, t) {
	...
	return e.asyncQueue.enqueueAndForget((async () => async function __PRIVATE_readDocumentFromCache(e$1, t$1, n$1) {
		try {
			...
			r.isFoundDocument() ? n$1.resolve(r) : r.isNoDocument() ? n$1.resolve(null) : n$1.reject(new FirestoreError(C.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)"));
		} catch (e$2) {
...
function __PRIVATE_firestoreClientGetDocumentsFromLocalCache(e, t) {
	...
	return e.asyncQueue.enqueueAndForget((async () => async function __PRIVATE_executeQueryFromCache(e$1, t$1, n$1) {
		try {
			const r = await __PRIVATE_localStoreExecuteQuery(e$1, t$1, !0), i = new __PRIVATE_View(t$1, r.ks), s = i.ru(r.documents), o = i.applyChanges(s, !1);
	...
	return e.asyncQueue.enqueueAndForget((async () => {
		try {
			...
			r.resolve(async function __PRIVATE_invokeRunAggregationQueryRpc(e$1, t$1, n$1) {
				...
				r$1.connection.Ko || delete i$1.parent;
				const _ = (await r$1.jo("RunAggregationQuery", r$1.serializer.databaseId, o, i$1, 1)).filter(((e$2) => !!e$2.result));
...
function __PRIVATE_firestoreClientGetNamedQuery(e, t) {
	return e.asyncQueue.enqueue((async () => function __PRIVATE_localStoreGetNamedQuery(e$1, t$1) {
		...
		return n.persistence.runTransaction("Get named query", "readonly", ((e$2) => n.Pi.getNamedQuery(e$2, t$1)));
...
function __PRIVATE_firestoreClientSetPersistentCacheIndexAutoCreationEnabled(e, t) {
	return e.asyncQueue.enqueue((async () => function __PRIVATE_localStoreSetIndexAutoCreationEnabled(e$1, t$1) {
		__PRIVATE_debugCast(e$1).Cs.As = t$1;
	}(await __PRIVATE_getLocalStore(e), t)));
}
	...
	constructor(e) {
		...
		__PRIVATE_validateIsNotUsedTogether("experimentalForceLongPolling", e.experimentalForceLongPolling, "experimentalAutoDetectLongPolling", e.experimentalAutoDetectLongPolling), this.experimentalForceLongPolling = !!e.experimentalForceLongPolling, this.experimentalForceLongPolling ? this.experimentalAutoDetectLongPolling = !1 : void 0 === e.experimentalAutoDetectLongPolling ? this.experimentalAutoDetectLongPolling = true : this.experimentalAutoDetectLongPolling = !!e.experimentalAutoDetectLongPolling, this.experimentalLongPollingOptions = __PRIVATE_cloneLongPollingOptions(e.experimentalLongPollingOptions ?? {}), function __PRIVATE_validateLongPollingOptions(e$1) {
			if (void 0 !== e$1.timeoutSeconds) {
				if (isNaN(e$1.timeoutSeconds)) throw new FirestoreError(C.INVALID_ARGUMENT, `invalid long polling timeout: ${e$1.timeoutSeconds} (must not be NaN)`);
				if (e$1.timeoutSeconds < 5) throw new FirestoreError(C.INVALID_ARGUMENT, `invalid long polling timeout: ${e$1.timeoutSeconds} (minimum allowed value is 5)`);
				if (e$1.timeoutSeconds > 30) throw new FirestoreError(C.INVALID_ARGUMENT, `invalid long polling timeout: ${e$1.timeoutSeconds} (maximum allowed value is 30)`);
			}
...
*/ function connectFirestoreEmulator(e, t, n, r = {}) {
	...
	if (!deepEqual(a, o) && (e._setSettings(a), r.mockUserToken)) {
		...
		if ("string" == typeof r.mockUserToken) t$1 = r.mockUserToken, n$1 = User.MOCK_USER;
			...
			if (!i$1) throw new FirestoreError(C.INVALID_ARGUMENT, "mockUserToken must contain 'sub' or 'user_id' field!");
			n$1 = new User(i$1);
		}
...
var __PRIVATE_AsyncQueueImpl = class {
	constructor(e = Promise.resolve()) {
		this.Yu = [], this.ec = !1, this.tc = [], this.nc = null, this.rc = !1, this.sc = !1, this.oc = [], this.M_ = new __PRIVATE_ExponentialBackoff(this, "async_queue_retry"), this._c = () => {
			...
			e$1 && __PRIVATE_logDebug(sn, "Visibility state changed to " + e$1.visibilityState), this.M_.w_();
		}, this.ac = e;
		const t = getDocument();
...
*/ var Bytes = class Bytes {
	...
	*/ static fromBase64String(e) {
		try {
			...
			throw new FirestoreError(C.INVALID_ARGUMENT, "Failed to construct data from Base64 string: " + e$1);
		}
	}
	/**
...
/** Parse document data from a set() call. */ function __PRIVATE_parseSetData(e, t, n, r, i, s = {}) {
	...
	if (s.merge) a = new FieldMask(o.fieldMask), u = o.fieldTransforms;
		...
		for (const r$1 of s.mergeFields) {
			const i$1 = __PRIVATE_fieldPathFromArgument(t, r$1, n);
			if (!o.contains(i$1)) throw new FirestoreError(C.INVALID_ARGUMENT, `Field '${i$1}' is specified in your field mask but missing from your input data.`);
...
var __PRIVATE_ArrayUnionFieldValueImpl = class __PRIVATE_ArrayUnionFieldValueImpl extends FieldValue {
	...
	_toFieldTransform(e) {
		const t = __PRIVATE_createSentinelChildContext(this, e, !0), n = this.Ac.map(((e$1) => __PRIVATE_parseData(e$1, t))), r = new __PRIVATE_ArrayUnionTransformOperation(n);
...
var __PRIVATE_ArrayRemoveFieldValueImpl = class __PRIVATE_ArrayRemoveFieldValueImpl extends FieldValue {
	...
	_toFieldTransform(e) {
		const t = __PRIVATE_createSentinelChildContext(this, e, !0), n = this.Ac.map(((e$1) => __PRIVATE_parseData(e$1, t))), r = new __PRIVATE_ArrayRemoveTransformOperation(n);
		return new FieldTransform(e.path, r);
	}
	isEqual(e) {
...
/** Parse update data from an update() call. */ function __PRIVATE_parseUpdateData(e, t, n, r) {
	...
	forEach(r, ((e$1, r$1) => {
		...
		const a = i.childContextForFieldPath(_$1);
...
/** Parse update data from a list of field/value arguments. */ function __PRIVATE_parseUpdateVarargs(e, t, n, r, i, s) {
	...
	for (let e$1 = 0; e$1 < s.length; e$1 += 2) _.push(__PRIVATE_fieldPathFromArgument(t, s[e$1])), a.push(s[e$1 + 1]);
	...
	for (let e$1 = _.length - 1; e$1 >= 0; --e$1) if (!__PRIVATE_fieldMaskContains(u, _[e$1])) {
		...
		const r$1 = o.childContextForFieldPath(t$1);
 ...
 /**
	...
	*/
	return function __PRIVATE_parseSentinelFieldValue(e$1, t$1) {
		if (!__PRIVATE_isWrite(t$1.dataSource)) throw t$1.createError(`${e$1._methodName}() can only be used with update() and set()`);
		if (!t$1.path) throw t$1.createError(`${e$1._methodName}() is not currently supported inside arrays`);
	...
	if (t.path && t.fieldMask.push(t.path), e instanceof Array) {
		...
		return function __PRIVATE_parseArray(e$1, t$1) {
			...
			let r = 0;
			for (const i of e$1) {
				let e$2 = __PRIVATE_parseData(i, t$1.childContextForArray(r));
	...
	return function __PRIVATE_parseScalarValue(e$1, t$1) {
		...
		if (e$1 instanceof DocumentReference) {
			...
			if (!r.isEqual(n)) throw t$1.createError(`Document reference is for database ${r.projectId}/${r.database} but should be for database ${n.projectId}/${n.database}`);
 ...
 /**
		...
		*/
		return function __PRIVATE_parseVectorValue(e$2, t$2) {
			const n = e$2 instanceof VectorValue ? e$2.toArray() : e$2;
			return { mapValue: { fields: {
				[ot]: { stringValue: ut },
				[ct]: { arrayValue: { values: n.map(((e$3) => {
					if ("number" != typeof e$3) throw t$2.createError("VectorValues must only contain numeric values.");
					return __PRIVATE_toDouble(t$2.serializer, e$3);
				})) } }
			} } };
		}(e$1, t$1);
		if (__PRIVATE_isProtoValueSerializable(e$1)) return e$1._toProto(t$1.serializer);
		throw t$1.createError(`Unsupported field value: ${__PRIVATE_valueDescription(e$1)}`);
	}(e, t);
}
function __PRIVATE_parseObject(e, t) {
	const n = {};
	return isEmpty(e) ? t.path && t.path.length > 0 && t.fieldMask.push(t.path) : forEach(e, ((e$1, r) => {
		const i = __PRIVATE_parseData(r, t.childContextForField(e$1));
		null != i && (n[e$1] = i);
	})), { mapValue: { fields: n } };
}
...
*/ var AbstractUserDataWriter = class {
	...
	*/ convertVectorValue(e) {
		const t = e.fields?.[ct].arrayValue?.values?.map(((e$1) => __PRIVATE_normalizeNumber(e$1.doubleValue)));
...
var Ut = "@firebase/firestore", Ht = "4.10.0";
/**
* @license
* Copyright 2017 Google LLC
*
...
function __PRIVATE_isPartialObserver(t) {
	...
	* methods.
	*/
	return function __PRIVATE_implementsAnyMethods(t$1, e) {
		if ("object" != typeof t$1 || null === t$1) return !1;
		const n = t$1;
		for (const t$2 of e) if (t$2 in n && "function" == typeof n[t$2]) return !0;
		return !1;
	}(t, [
		"next",
		"error",
...
function query(t, e, ...n) {
	let r = [];
	e instanceof AppliableConstraint && r.push(e), r = r.concat(n), function __PRIVATE_validateQueryConstraintArray(t$1) {
		const e$1 = t$1.filter(((t$2) => t$2 instanceof QueryCompositeFilterConstraint)).length, n$1 = t$1.filter(((t$2) => t$2 instanceof QueryFieldFilterConstraint)).length;
		if (e$1 > 1 || e$1 > 0 && n$1 > 0) throw new FirestoreError(C.INVALID_ARGUMENT, "InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.");
	}(r);
	for (const e$1 of r) t = e$1._apply(t);
	return t;
}
/**
...
*/ var QueryFieldFilterConstraint = class QueryFieldFilterConstraint extends QueryConstraint {
	...
	*/
	...
	_parse(t) {
		...
		return function __PRIVATE_newQueryFilter(t$1, e$1, n, r, s, a, o) {
			let i;
			if (s.isKeyField()) {
				...
				if ("in" === a || "not-in" === a) {
					...
					const e$2 = [];
					for (const n$1 of o) e$2.push(__PRIVATE_parseDocumentIdValue(r, t$1, n$1));
					i = { arrayValue: { values: e$2 } };
				} else i = __PRIVATE_parseDocumentIdValue(r, t$1, o);
			} else "in" !== a && "not-in" !== a && "array-contains-any" !== a || __PRIVATE_validateDisjunctiveFilterElements(o, a), i = __PRIVATE_parseQueryValue(n, e$1, o, "in" === a || "not-in" === a);
...
*/ var QueryCompositeFilterConstraint = class QueryCompositeFilterConstraint extends AppliableConstraint {
	...
	*/
	...
	_parse(t) {
		const e = this._queryConstraints.map(((e$1) => e$1._parse(t))).filter(((t$1) => t$1.getFilters().length > 0));
		return 1 === e.length ? e[0] : CompositeFilter.create(e, this._getOperator());
	}
	_apply(t) {
		const e = this._parse(t);
		return 0 === e.getFilters().length ? t : (function __PRIVATE_validateNewFilter(t$1, e$1) {
			let n = t$1;
			const r = e$1.getFlattenedFilters();
			for (const t$2 of r) __PRIVATE_validateNewFieldFilter(n, t$2), n = __PRIVATE_queryWithAddedFilter(n, t$2);
...
*/ function or(...t) {
	return t.forEach(((t$1) => __PRIVATE_validateQueryFilterConstraint("or", t$1))), QueryCompositeFilterConstraint._create("or", t);
}
/**
...
* @returns The newly created {@link QueryCompositeFilterConstraint}.
*/ function and(...t) {
	return t.forEach(((t$1) => __PRIVATE_validateQueryFilterConstraint("and", t$1))), QueryCompositeFilterConstraint._create("and", t);
}
/**
...
*/ var QueryOrderByConstraint = class QueryOrderByConstraint extends QueryConstraint {
	...
	*/
	...
	_apply(t) {
		const e = function __PRIVATE_newQueryOrderBy(t$1, e$1, n) {
			if (null !== t$1.startAt) throw new FirestoreError(C.INVALID_ARGUMENT, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
			if (null !== t$1.endAt) throw new FirestoreError(C.INVALID_ARGUMENT, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
			return new OrderBy(e$1, n);
...
/** Helper function to create a bound from a document or fields */ function __PRIVATE_newQueryBoundFromDocOrFields(t, e, n, r) {
	if (n[0] = getModularInstance(n[0]), n[0] instanceof DocumentSnapshot$1) return function __PRIVATE_newQueryBoundFromDocument(t$1, e$1, n$1, r$1, s) {
		if (!r$1) throw new FirestoreError(C.NOT_FOUND, `Can't use a DocumentSnapshot that doesn't exist for ${n$1}().`);
		const a = [];
		for (const n$2 of __PRIVATE_queryNormalizedOrderBy(t$1)) if (n$2.field.isKeyField()) a.push(__PRIVATE_refValue(e$1, r$1.key));
		else {
			const t$2 = r$1.data.field(n$2.field);
			if (__PRIVATE_isServerTimestamp(t$2)) throw new FirestoreError(C.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field \"" + n$2.field + "\" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)");
			if (null === t$2) {
				const t$3 = n$2.field.canonicalString();
				throw new FirestoreError(C.INVALID_ARGUMENT, `Invalid query. You are trying to start or end a query using a document for which the field '${t$3}' (used as the orderBy) does not exist.`);
			}
			a.push(t$2);
		}
	...
	}(t._query, t.firestore._databaseId, e, n[0]._document, r);
	{
		...
		return function __PRIVATE_newQueryBoundFromFields(t$1, e$1, n$1, r$1, s$1, a) {
			const o = t$1.explicitOrderBy;
			if (s$1.length > o.length) throw new FirestoreError(C.INVALID_ARGUMENT, `Too many arguments provided to ${r$1}(). The number of arguments must be less than or equal to the number of orderBy() clauses`);
			const i = [];
			for (let a$1 = 0; a$1 < s$1.length; a$1++) {
				const u = s$1[a$1];
				if (o[a$1].field.isKeyField()) {
					if ("string" != typeof u) throw new FirestoreError(C.INVALID_ARGUMENT, `Invalid query. Expected a string for document ID in ${r$1}(), but got a ${typeof u}`);
					if (!__PRIVATE_isCollectionGroupQuery(t$1) && -1 !== u.indexOf("/")) throw new FirestoreError(C.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by documentId(), the value passed to ${r$1}() must be a plain document ID, but '${u}' contains a slash.`);
					const n$2 = t$1.path.child(ResourcePath.fromString(u));
					if (!DocumentKey.isDocumentKey(n$2)) throw new FirestoreError(C.INVALID_ARGUMENT, `Invalid query. When querying a collection group and ordering by documentId(), the value passed to ${r$1}() must result in a valid document path, but '${n$2}' is not because it contains an odd number of segments.`);
					const s$2 = new DocumentKey(n$2);
					i.push(__PRIVATE_refValue(e$1, s$2));
				} else {
					const t$2 = __PRIVATE_parseQueryValue(n$1, r$1, u);
					i.push(t$2);
				}
			}
...
*/ function __PRIVATE_validateNewFieldFilter(t, e) {
	const n = function __PRIVATE_findOpInsideFilters(t$1, e$1) {
		for (const n$1 of t$1) for (const t$2 of n$1.getFlattenedFilters()) if (e$1.indexOf(t$2.op) >= 0) return t$2.op;
		return null;
	}(t.filters, function __PRIVATE_conflictingOps(t$1) {
		switch (t$1) {
			case "!=": return ["!=", "not-in"];
...
*/ function getAggregateFromServer(t, e) {
	const n = __PRIVATE_cast(t.firestore, Firestore), r = ensureFirestoreConfigured(n), s = __PRIVATE_mapToArray(e, ((t$1, e$1) => new __PRIVATE_AggregateImpl(e$1, t$1.aggregateType, t$1._internalFieldPath)));
	return __PRIVATE_firestoreClientRunAggregateQuery(r, t._query, s).then(((e$1) => function __PRIVATE_convertToAggregateQuerySnapshot(t$1, e$2, n$1) {
		const r$1 = new __PRIVATE_ExpUserDataWriter(t$1);
		return new AggregateQuerySnapshot(e$2, r$1, n$1);
	}(n, t, e$1)));
}
...
*/ var QuerySnapshot = class QuerySnapshot {
	...
	*/ docChanges(t = {}) {
		...
		return this._cachedChanges && this._cachedChangesIncludeMetadataChanges === e || (this._cachedChanges = function __PRIVATE_changesFromSnapshot(t$1, e$1) {
			if (t$1._snapshot.oldDocs.isEmpty()) {
				let e$2 = 0;
				return t$1._snapshot.docChanges.map(((n) => {
					const r = new QueryDocumentSnapshot(t$1._firestore, t$1._userDataWriter, n.doc.key, n.doc, new SnapshotMetadata(t$1._snapshot.mutatedKeys.has(n.doc.key), t$1._snapshot.fromCache), t$1.query.converter);
					return n.doc, {
						type: "added",
						doc: r,
						oldIndex: -1,
			...
			{
				let n = t$1._snapshot.oldDocs;
				return t$1._snapshot.docChanges.filter(((t$2) => e$1 || 3 !== t$2.type)).map(((e$2) => {
					const r = new QueryDocumentSnapshot(t$1._firestore, t$1._userDataWriter, e$2.doc.key, e$2.doc, new SnapshotMetadata(t$1._snapshot.mutatedKeys.has(e$2.doc.key), t$1._snapshot.fromCache), t$1.query.converter);
					let s = -1, a = -1;
					return 0 !== e$2.type && (s = n.indexOf(e$2.doc.key), n = n.delete(e$2.doc.key)), 1 !== e$2.type && (n = n.add(e$2.doc), a = n.indexOf(e$2.doc.key)), {
						type: __PRIVATE_resultChangeType(e$2.type),
						doc: r,
						oldIndex: s,
						newIndex: a
					};
	...
	*/ toJSON() {
		...
		const e = [], n = [], r = [];
		return this.docs.forEach(((t$1) => {
			null !== t$1._document && (e.push(t$1._document), n.push(this._userDataWriter.convertObjectMap(t$1._document.data.value.mapValue.fields, "previous")), r.push(t$1.ref.path));
...
function querySnapshotFromJSON(t, e, n) {
	if (__PRIVATE_validateJSON(e, QuerySnapshot._jsonSchema)) {
		...
		u.map(((t$1) => {
			const e$1 = __PRIVATE_fromDocument(r, t$1.document);
			c = c.add(e$1);
		}));
...
*/ var Transaction$1 = class {
	...
	*/ get(t) {
		...
		return this._transaction.lookup([e._key]).then(((t$1) => {
			if (!t$1 || 1 !== t$1.length) return fail(24041);
			const r = t$1[0];
...
*/ var Transaction = class extends Transaction$1 {
	...
	*/ get(t) {
		...
		return super.get(t).then(((t$1) => new DocumentSnapshot(this._firestore, n, e._key, t$1._document, new SnapshotMetadata(!1, !1), e.converter)));
	}
};
/**
...
*/ function runTransaction(t, e, n) {
	...
	(function __PRIVATE_validateTransactionOptions(t$1) {
		if (t$1.maxAttempts < 1) throw new FirestoreError(C.INVALID_ARGUMENT, "Max attempts must be at least 1");
	})(r);
	const s = ensureFirestoreConfigured(t);
	return __PRIVATE_firestoreClientTransaction(s, ((n$1) => e(new Transaction(t, n$1))), r);
}
/**
* @license
* Copyright 2020 Google LLC
...
*/ function getDoc(t) {
	...
	return __PRIVATE_firestoreClientGetDocumentViaSnapshotListener(n, t._key).then(((n$1) => __PRIVATE_convertToDocSnapshot(e, t, n$1)));
}
/**
...
*/ function getDocFromCache(t) {
	...
	return __PRIVATE_firestoreClientGetDocumentFromLocalCache(n, t._key).then(((n$1) => new DocumentSnapshot(e, r, t._key, n$1, new SnapshotMetadata(null !== n$1 && n$1.hasLocalMutations, !0), t.converter)));
}
/**
...
*/ function getDocFromServer(t) {
	t = __PRIVATE_cast(t, DocumentReference);
	const e = __PRIVATE_cast(t.firestore, Firestore), n = ensureFirestoreConfigured(e);
	return __PRIVATE_firestoreClientGetDocumentViaSnapshotListener(n, t._key, { source: "server" }).then(((n$1) => __PRIVATE_convertToDocSnapshot(e, t, n$1)));
}
/**
...
*/ function getDocs(t) {
	...
	const e = __PRIVATE_cast(t.firestore, Firestore), n = ensureFirestoreConfigured(e), r = new __PRIVATE_ExpUserDataWriter(e);
	return __PRIVATE_validateHasExplicitOrderByForLimitToLast(t._query), __PRIVATE_firestoreClientGetDocumentsViaSnapshotListener(n, t._query).then(((n$1) => new QuerySnapshot(e, r, t, n$1)));
}
/**
...
*/ function getDocsFromCache(t) {
	t = __PRIVATE_cast(t, Query);
	const e = __PRIVATE_cast(t.firestore, Firestore), n = ensureFirestoreConfigured(e), r = new __PRIVATE_ExpUserDataWriter(e);
	return __PRIVATE_firestoreClientGetDocumentsFromLocalCache(n, t._query).then(((n$1) => new QuerySnapshot(e, r, t, n$1)));
}
/**
...
*/ function getDocsFromServer(t) {
	t = __PRIVATE_cast(t, Query);
	const e = __PRIVATE_cast(t.firestore, Firestore), n = ensureFirestoreConfigured(e), r = new __PRIVATE_ExpUserDataWriter(e);
	return __PRIVATE_firestoreClientGetDocumentsViaSnapshotListener(n, t._query, { source: "server" }).then(((n$1) => new QuerySnapshot(e, r, t, n$1)));
}
...
function onSnapshot(t, ...e) {
	...
	if (__PRIVATE_isPartialObserver(e[r])) {
		const t$1 = e[r];
		e[r] = t$1.next?.bind(t$1), e[r + 1] = t$1.error?.bind(t$1), e[r + 2] = t$1.complete?.bind(t$1);
	}
	let o, i, u;
	if (t instanceof DocumentReference) i = __PRIVATE_cast(t.firestore, Firestore), u = __PRIVATE_newQueryForPath(t._key.path), o = {
		next: (n$1) => {
			e[r] && e[r](__PRIVATE_convertToDocSnapshot(i, t, n$1));
		},
		error: e[r + 1],
		complete: e[r + 2]
	};
	else {
		const n$1 = __PRIVATE_cast(t, Query);
		i = __PRIVATE_cast(n$1.firestore, Firestore), u = n$1._query;
		const s$1 = new __PRIVATE_ExpUserDataWriter(i);
		o = {
			next: (t$1) => {
				e[r] && e[r](new QuerySnapshot(i, s$1, n$1, t$1));
			},
			error: e[r + 1],
			complete: e[r + 2]
...
function onSnapshotResume(t, e, ...n) {
	const r = getModularInstance(t), s = function __PRIVATE_normalizeSnapshotJsonFields(t$1) {
		const e$1 = {
			bundle: "",
			bundleName: "",
			bundleSource: ""
		...
		for (const r$1 of [
			...
			if (!(r$1 in t$1)) {
				e$1.error = `snapshotJson missing required field: ${r$1}`;
				break;
			}
			const n$1 = t$1[r$1];
			if ("string" != typeof n$1) {
				e$1.error = `snapshotJson field '${r$1}' must be a string.`;
				break;
			}
			if (0 === n$1.length) {
				e$1.error = `snapshotJson field '${r$1}' cannot be an empty string.`;
				break;
			}
			"bundle" === r$1 ? e$1.bundle = n$1 : "bundleName" === r$1 ? e$1.bundleName = n$1 : "bundleSource" === r$1 && (e$1.bundleSource = n$1);
		}
		return e$1;
	}(e);
	...
	if ("object" != typeof n[o] || __PRIVATE_isPartialObserver(n[o]) || (a = n[o++]), "QuerySnapshot" === s.bundleSource) {
		...
		* @internal
		*/
		return function __PRIVATE_onSnapshotQuerySnapshotBundle(t$2, e$1, n$1, r$1, s$1) {
			let a$1, o$1 = !1;
			return loadBundle(t$2, e$1.bundle).then((() => namedQuery(t$2, e$1.bundleName))).then(((t$3) => {
				if (t$3 && !o$1) s$1 && t$3.withConverter(s$1), a$1 = onSnapshot(t$3, n$1 || {}, r$1);
			})).catch(((t$3) => (r$1.error && r$1.error(t$3), () => {}))), () => {
				o$1 || (o$1 = !0, a$1 && a$1());
			};
		}(r, s, a, t$1, n[o]);
	}
	if ("DocumentSnapshot" === s.bundleSource) {
		...
		return function __PRIVATE_onSnapshotDocumentSnapshotBundle(t$2, e$1, n$1, r$1, s$1) {
			let a$1, o$1 = !1;
			return loadBundle(t$2, e$1.bundle).then((() => {
				if (!o$1) {
					const o$2 = new DocumentReference(t$2, s$1 || null, DocumentKey.fromPath(e$1.bundleName));
					a$1 = onSnapshot(o$2, n$1 || {}, r$1);
				}
			})).catch(((t$3) => (r$1.error && r$1.error(t$3), () => {}))), () => {
				o$1 || (o$1 = !0, a$1 && a$1());
			};
...
function onSnapshotsInSync(t, e) {
	t = __PRIVATE_cast(t, Firestore);
	const n = ensureFirestoreConfigured(t), r = __PRIVATE_isPartialObserver(e) ? e : { next: e };
...
*/ function setIndexConfiguration(t, e) {
	...
	const r = function __PRIVATE_parseIndexes(t$1) {
		const e$1 = "string" == typeof t$1 ? function __PRIVATE_tryParseJson(t$2) {
			try {
				return JSON.parse(t$2);
			} catch (t$3) {
				throw new FirestoreError(C.INVALID_ARGUMENT, "Failed to parse JSON: " + t$3?.message);
			}
		}(t$1) : t$1, n$1 = [];
		if (Array.isArray(e$1.indexes)) for (const t$2 of e$1.indexes) {
			const e$2 = __PRIVATE_tryGetString(t$2, "collectionGroup"), r$1 = [];
			if (Array.isArray(t$2.fields)) for (const e$3 of t$2.fields) {
				const t$3 = __PRIVATE_tryGetString(e$3, "fieldPath"), n$2 = __PRIVATE_fieldPathFromDotSeparatedString("setIndexConfiguration", t$3);
				"CONTAINS" === e$3.arrayConfig ? r$1.push(new IndexSegment(n$2, 2)) : "ASCENDING" === e$3.order ? r$1.push(new IndexSegment(n$2, 0)) : "DESCENDING" === e$3.order && r$1.push(new IndexSegment(n$2, 1));
			}
			n$1.push(new FieldIndex(FieldIndex.UNKNOWN_ID, e$2, r$1, IndexState.empty()));
		}
		return n$1;
	}(e);
...
*/ function deleteAllPersistentCacheIndexes(t) {
	...
	__PRIVATE_firestoreClientDeleteAllFieldIndexes(e).then(((t$1) => __PRIVATE_logDebug("deleting all persistent cache indexes succeeded"))).catch(((t$1) => __PRIVATE_logWarn("deleting all persistent cache indexes failed", t$1)));
}
function __PRIVATE_setPersistentCacheIndexAutoCreationEnabled(t, e) {
	const n = ensureFirestoreConfigured(t._firestore);
	__PRIVATE_firestoreClientSetPersistentCacheIndexAutoCreationEnabled(n, e).then(((t$1) => __PRIVATE_logDebug(`setting persistent cache index auto creation isEnabled=${e} succeeded`))).catch(((t$1) => __PRIVATE_logWarn(`setting persistent cache index auto creation isEnabled=${e} failed`, t$1)));
}
/**
